...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().some(c => c.id === 'webdesign-6-12')) {
      ...
      coursesDb.create({ id: 'webdesign-6-12', name: 'Графіка та дизайн: Photoshop + Illustrator', emoji: '🎨', age: '6–12 років', age_group: '6-12', description: 'Від растру до вектору, від ретуші до брендингу — 30 тем · 156 занять', lessonsCount: 156, ...shared, curriculum: [
        { num: '01', title: 'Знайомство з Adobe Photoshop', desc: 'Растрова та векторна графіка: відмінності. Колірні моделі RGB/CMYK. Створення та збереження файлів.' },
        { num: '02', title: 'Інструменти виділення', desc: 'Чарівна паличка, ласо, маска, колірний діапазон. Трансформація, доповнення та перетин областей виділення.' },
        { num: '03', title: 'Шари, штамп та ретуш фотографії', desc: 'Поняття шарів та їх параметри. Стилі шарів. Ретуш портрету: Clone Stamp, Healing Brush, Liquify.' },
        { num: '04', title: 'Робота з текстом у Photoshop', desc: 'Текстові шари, деформація напису, ефекти: вогняний текст, залізний текст, стилі.' },
        { num: '05', title: 'Мокапи. Смарт-фільтри. Брендинг', desc: 'Що таке мокап, створення власного. Смарт-фільтри. Логотип на шкірі, дереві, металі.' },
        { num: '06', title: 'Художня обробка фото', desc: 'Макіяж, фотоколаж, тіні та світло, Color Balance, ретуш пейзажу, корекція перспективи.' },
        { num: '07', title: 'Корекція кольору. Маски шару', desc: 'Базова корекція, коригувальні шари, тонові криві Curves, конвертація у чорно-біле, складний колаж.' },
        { num: '08', title: 'Малюємо у Photoshop', desc: 'Цифрове малювання без планшета. Графічний планшет. Крива Безьє, контури, векторні фігури.' },
        { num: '09', title: 'Анімація у Photoshop', desc: 'Шкала часу, створення слайдів. Анімація батареї та годинника з незалежними стрілками.' },
        { num: '10', title: 'Спецефекти та окремі випадки', desc: 'Подвійна експозиція, зображення що розсипається, 3D-графіка, акварельний ефект, відновлення фото.' },
        { num: '11', title: 'Вступ до Adobe Illustrator', desc: 'Векторна графіка та її застосування. Інтерфейс Illustrator, документи, шаблони, навігація.' },
        { num: '12', title: 'Маніпуляції з об\'єктами та контурами', desc: 'Копіювання, вирівнювання, групування. Малювання ліній, типи кистей, інструмент Безьє.' },
        { num: '13', title: 'Прості фігури та трансформація', desc: 'Прямокутники, еліпси, зірки, спіралі, сітки. Виділення та трансформація об\'єктів, перетікання.' },
        { num: '14', title: 'Колір, текстури та фільтри', desc: 'Заливки, градієнти, градієнтна сітка, текстури. Прозорість, режими змішування, ефекти.' },
        { num: '15', title: 'Шари та маски в Illustrator', desc: 'Робота з палітрою Layers, типи масок, маски непрозорості. Точний контроль видимості об\'єктів.' },
        { num: '16', title: 'Допоміжні засоби Illustrator', desc: 'Лінійки, направляючі, смарт-направляючі, прив\'язка до сітки — точне малювання.' },
        { num: '17', title: 'Текст в Illustrator', desc: 'Шрифт та атрибути, текст вздовж кривої, перетворення у криві, неоновий ефект, візитка.' },
        { num: '18', title: 'Спеціальні засоби Illustrator', desc: 'Кисті для складних обводок, оболонки деформації, символи, діаграми, вітальна листівка.' },
        { num: '19', title: 'Об\'ємні зображення. 3D в Illustrator', desc: 'Обертання та витягування об\'єктів, 3D-ефекти, будівлі, прототип телефону, рендеринг, трасування.' },
        { num: '20', title: 'Растрові зображення в Illustrator', desc: 'Розміщення, трансформація, конвертація растр↔вектор. Live Paint, палітра Links, кадрування.' },
        { num: '21', title: 'Підготовка до друку та експорт', desc: 'Вильоти, відступи, перевірка кольору. Вимоги друкарні, підготовка макета, параметри друку, експорт.' },
        { num: '22', title: 'Підготовка для Web', desc: 'Команди Slice, експорт у JPEG, GIF, PNG, SVG. Діалогове вікно Save for Web.' },
        { num: '23', title: 'Практичні кейси', desc: 'Гірський пейзаж, набір іконок для продажу, флет-дизайн, іконки для сайту.' },
        { num: '24', title: 'Як отримати роботу дизайнером', desc: 'Портфоліо, в чому себе спробувати, професійні ресурси, авторське право, робота зі стоком.' },
        { num: '25', title: 'Поліграфія. Розробка візитки', desc: 'Види поліграфії, розміри та правила. Робота з клієнтом і друкарнею, колірні профілі, практика.' },
        { num: '26', title: 'Брендбук та гайдлайн', desc: 'Загальні правила створення, розробка брендбуку на задану тематику. Передрукова підготовка.' },
        { num: '27', title: 'Флаєри, буклети, оголошення', desc: 'Теорія поліграфії та передрукової підготовки. Створення власних макетів за зразком.' },
        { num: '28', title: 'Створення логотипу', desc: 'Розробка логотипу в Illustrator. Створення 6 варіантів реалізації одного логотипу.' },
        { num: '29', title: 'Модерація соціальних мереж', desc: 'Роль соцмереж у сучасних продажах, практичне використання, створення та брендування акаунтів.' },
        { num: '🚀', title: 'Мобільні ігри: дизайн та проектування', desc: 'Теорія геймдизайну, кнопки, меню, шкали. Розробка маджонгу, пазлів, гонок, монетизація.' },
      ]});
      coursesDb.create({ id: 'webdesign-12-18', name: 'Веб-дизайн та UI/UX: від верстки до портфоліо', emoji: '💼', age: '12–18 років', age_group: '12-18', description: 'HTML, CSS, JS, Figma, анімація та перший фріланс — 28 тем · 156 занять', lessonsCount: 156, ...shared, curriculum: [
        { num: '01', title: 'Вступ до веб-розробки', desc: 'Як працюють сайти, backend і frontend. Sublime Text, перша HTML-сторінка, теги, атрибути, CSS-стилі.' },
        { num: '02', title: 'Мова HTML', desc: 'Структура HTML5, основні теги, веб-форми, валідація, таблиці, семантична верстка та стандарти.' },
        { num: '03', title: 'Історія та стандарти', desc: 'Розвиток інтернету, WWW, XHTML, блокові та лінійні елементи, заголовки H1-H6, редактори та браузери.' },
        { num: '04', title: 'Основи CSS', desc: 'Синтаксис CSS, правила каскадності, групування та успадкування стилів, пріоритети.' },
        { num: '05', title: 'Селектори CSS', desc: 'Комбіновані селектори, групування та успадкування, пріоритети стилів у CSS.' },
        { num: '06', title: 'Посилання та шляхи', desc: 'Тег посилання, відносні та абсолютні шляхи, URL/URN, фрагменти сторінки, іменування папок.' },
        { num: '07', title: 'Списки, символи, метадані', desc: 'Марковані та нумеровані списки, Unicode, MIME-типи, метадані KEYWORDS та DESCRIPTION, SEO-основи.' },
        { num: '08', title: 'CSS. Блокова модель та позиціонування', desc: 'Box model, border/margin/padding, обтікання, навігація, Relative/Absolute/Flex/Fixed.' },
        { num: '09', title: 'Шрифти та текст', desc: 'Шрифтове та текстове оформлення, вирівнювання, інтерліньяж, кернінг, колір, написання текстів для Web.' },
        { num: '10', title: 'Кольори та зображення', desc: 'Колірні моделі в CSS, формати JPEG/GIF/PNG, фонові зображення, градієнт, тіні, UI-генератори.' },
        { num: '11', title: 'Розташування елементів (CSS)', desc: 'Relative/Absolute, z-index, селектори по ієрархії, класи та ідентифікатори, зовнішні таблиці стилів.' },
        { num: '12', title: 'Таблиці', desc: 'Структура таблиці, об\'єднання комірок, оформлення класами, карти посилань, застаріла таблична верстка.' },
        { num: '13', title: 'Медіазапити', desc: 'Синтаксис медіазапитів, логічні оператори, viewport, стратегії адаптивності, орієнтири по розмірах екрану.' },
        { num: '14', title: 'Псевдокласи та анімації CSS', desc: 'Псевдокласи тексту, посилань, кнопок, оформлення списків, бібліотека Animate.css, практика блоків.' },
        { num: '15', title: 'Підсумки базової верстки', desc: 'Розподіл наповнення та оформлення, ініціатива доступності Web, розміщення сторінок в інтернеті.' },
        { num: '16', title: 'Адаптивність та кросбраузерність', desc: 'Гумовий сайт, media-запити, Flexbox, сітки, особливості браузерів, інструменти перевірки.' },
        { num: '17', title: 'Flexbox', desc: 'Гнучкий контейнер, осі, порядок елементів, багаторядковість, коефіцієнти зростання/стиснення, вирівнювання.' },
        { num: '18', title: 'Advanced CSS', desc: 'Складні селектори, !important, псевдо-елементи, трансформації, БЕМ, Bootstrap, SASS/LESS.' },
        { num: '19', title: 'Основи JavaScript', desc: 'Підключення JS, jQuery, обробка подій, показ/приховання елементів, робота з мережею, JS-фреймворки.' },
        { num: '20', title: 'Оформлення веб-проекту', desc: 'Фон, градієнти, тіні, типографіка, спецсимволи, формати зображень, Favicon, SVG та Canvas.' },
        { num: '21', title: 'Знайомство з Figma', desc: 'Фрейми, компоненти, Auto Layout, стилі — сучасний інструмент UI-дизайнера та верстальника.' },
        { num: '22', title: 'UI-кіт та прототип у Figma', desc: 'Design System, кольорові токени, варіанти компонентів, інтерактивний прототип для клієнта.' },
        { num: '23', title: 'UX Research та проектування', desc: 'User Persona, Customer Journey Map, wireframes, usability testing — думаємо як користувач.' },
        { num: '24', title: 'Анімація CSS та JavaScript', desc: 'Keyframes, transitions, GSAP, Lottie — живі ефекти на сайті без Flash та додаткових плагінів.' },
        { num: '25', title: 'Adobe Photoshop для Web', desc: 'Нарізка макету, оптимізація зображень для завантаження, мокапи, ретуш для сайту.' },
        { num: '26', title: 'Motion Design: анімація інтерфейсів', desc: 'Smart Animate у Figma, мікроанімації, After Effects для лого — як зробити дизайн живим.' },
        { num: '27', title: 'Ведення власних проектів та фріланс', desc: 'Upwork, Behance, GitHub Pages — портфоліо, ставки, NDA, перший контракт на веб-дизайн.' },
        { num: '🚀', title: 'Інструменти верстальника. Дипломна робота', desc: 'Домен та хостинг, Git, таск-трекери, збирачі, мініфікатори. Публікація власного сайту.' },
      ]});
