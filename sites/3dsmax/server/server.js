...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (3dsmax.mycomputer.school)',
        heading: 'Курс 3D-інтер\'єрів та ландшафтів у 3ds Max для підлітків — My Computer Academy',
        text: 'Курс 3D-інтер\'єрів та ландшафтів у 3ds Max для підлітків 12–18 років у My Computer Academy: моделювання меблів і простору, матеріали, візуалізація у V-Ray/Corona. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо підлітків від 12 років — вік, коли вже комфортно освоювати 3ds Max, AutoCAD та Photoshop.', ru:'Принимаем подростков от 12 лет — возраст, когда уже комфортно осваивать 3ds Max, AutoCAD и Photoshop.' } },
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс 3D-інтер\'єрів та ландшафтів триває 18 місяців при 1–2 заняттях на тиждень — від основ 3ds Max до захисту власного портфоліо.', ru:'Полный курс 3D-интерьеров и ландшафтов длится 18 месяцев при 1–2 занятиях в неделю — от основ 3ds Max до защиты собственного портфолио.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        id: '3d-interior', name: "3D-ландшафти та інтер'єри (3ds Max)", name_ru: "3D-ландшафты и интерьеры (3ds Max)", emoji: "🏛️",
        age: "12–18 років", age_group: "12-18",
        duration: "18 місяців", lessonsCount: 144,
        groupSize: 5, price: 3600, color: "#C94B37",
        description: "Моделювання інтер'єрів та ландшафтів у 3ds Max з реалістичним світлом і матеріалами через V-Ray/Corona.",
        description_ru: "Моделирование интерьеров и ландшафтов в 3ds Max с реалистичным светом и материалами через V-Ray/Corona.",
        curriculum: [
        {"num":"Тема 1","title":"Як завантажити і встановити програми","desc":"Знайомство зі спеціальностями галузі, огляд програм 3ds Max, AutoCAD, Photoshop, взаємодія форматів файлів та основні етапи моделювання.","title_ru":"Как скачать и установить программы","desc_ru":"Знакомство со специальностями отрасли, обзор программ 3ds Max, AutoCAD, Photoshop, взаимодействие форматов файлов и основные этапы моделирования."},
        {"num":"Тема 2","title":"Знайомство з 3ds Max. Стіни та план","desc":"Інтерфейс 3ds Max, імпорт векторних планів, інструмент прив'язки, стандартні об'єкти та базові модифікатори, зведення стін за планом.","title_ru":"Знакомство с 3ds Max. Стены и план","desc_ru":"Интерфейс 3ds Max, импорт векторных планов, инструмент привязки, стандартные объекты и базовые модификаторы, возведение стен по плану."},
        {"num":"Тема 3","title":"Підвіконня, меблі та балки","desc":"Зведення підвіконь і балок, копіювання об'єктів та робота з координатними осями, імпорт готових моделей, інструменти обертання й масштабування.","title_ru":"Подоконники, мебель и балки","desc_ru":"Возведение подоконников и балок, копирование объектов и работа с координатными осями, импорт готовых моделей, инструменты вращения и масштабирования."},
        {"num":"Тема 4","title":"Двері, вікна та їх модифікації","desc":"Створення дверей і вікон, модифікатор Edit-Poly, робота з ребрами та полігонами, інструменти Inset, Extrude, Chamfer, Connect та Attach.","title_ru":"Двери, окна и их модификации","desc_ru":"Создание дверей и окон, модификатор Edit-Poly, работа с рёбрами и полигонами, инструменты Inset, Extrude, Chamfer, Connect и Attach."},
        {"num":"Тема 5","title":"Раковина. Кран. Кухня","desc":"Логічні операції над об'єктами, моделювання раковини, стільниці та крана, створення кухонних шаф і повноцінної кухні.","title_ru":"Раковина. Кран. Кухня","desc_ru":"Логические операции над объектами, моделирование раковины, столешницы и крана, создание кухонных шкафов и полноценной кухни."},
        {"num":"Тема 6","title":"Штори, ковдра, подушки і тощо","desc":"Модифікатор Cloth для м'яких об'єктів, моделювання ковдри та подушок, основи анімації і робота з ключовими кадрами на прикладі штор.","title_ru":"Шторы, одеяло, подушки и т.д.","desc_ru":"Модификатор Cloth для мягких объектов, моделирование одеяла и подушек, основы анимации и работа с ключевыми кадрами на примере штор."},
        {"num":"Тема 7","title":"Дивани, столи та стільці","desc":"Огляд моделей меблів, модифікатори Bend та FFD, створення офісного стільця, дивана та стола, завершення інтер'єру кухні та вітальні.","title_ru":"Диваны, столы и стулья","desc_ru":"Обзор моделей мебели, модификаторы Bend и FFD, создание офисного стула, дивана и стола, завершение интерьера кухни и гостиной."},
        {"num":"Тема 8","title":"Плінтуса, карнизи та інший декор","desc":"Огляд стилів інтер'єру, розробка базового та екстер'єрного декору, вінтажні меблі, моделювання плінтусів і карнизів.","title_ru":"Плинтусы, карнизы и другой декор","desc_ru":"Обзор стилей интерьера, разработка базового и экстерьерного декора, винтажная мебель, моделирование плинтусов и карнизов."},
        {"num":"Тема 9","title":"Ванна, туалет, сантехніка","desc":"Аналіз стилів сантехніки, моделювання ванни та унітаза, створення басейну з водою через модифікатор Noise.","title_ru":"Ванна, туалет, сантехника","desc_ru":"Анализ стилей сантехники, моделирование ванны и унитаза, создание бассейна с водой через модификатор Noise."},
        {"num":"Тема 10","title":"Моделювання хутра та трави. Спальня","desc":"Створення хутра та трави через Мультискаттер, моделювання ліжка й ламп модифікаторами TurboSmooth і Lathe, повноцінна спальня.","title_ru":"Моделирование меха и травы. Спальня","desc_ru":"Создание меха и травы через Мультискаттер, моделирование кровати и ламп модификаторами TurboSmooth и Lathe, полноценная спальня."},
        {"num":"Тема 11","title":"Складний план будівлі","desc":"Робота з великими проєктами, підготовка планів для замовника, дотримання ГОСТів у плануванні, створення багатоповерхової будівлі.","title_ru":"Сложный план здания","desc_ru":"Работа с крупными проектами, подготовка планов для заказчика, соблюдение ГОСТов в планировании, создание многоэтажного здания."},
        {"num":"Тема 12","title":"Екстер'єрна візуалізація","desc":"Основи екстер'єрної візуалізації, огляд рендерів та оптимізація навантаження, моделювання першої сцени з деревиною, камінням і травою.","title_ru":"Экстерьерная визуализация","desc_ru":"Основы экстерьерной визуализации, обзор рендеров и оптимизация нагрузки, моделирование первой сцены с древесиной, камнями и травой."},
        {"num":"Тема 13","title":"Редактор матеріалів","desc":"Принцип роботи редактора матеріалів, карти та текстури, HDR-карти, підключення бібліотек текстур і створення перших матеріалів рендера.","title_ru":"Редактор материалов","desc_ru":"Принцип работы редактора материалов, карты и текстуры, HDR-карты, подключение библиотек текстур и создание первых материалов рендера."},
        {"num":"Тема 14","title":"Складний матеріал. Бібліотека. Нормаль","desc":"Підключення сторонніх бібліотек матеріалів і скриптів, створення скла, металу, пластику та шкіри, карти нормалей і власні текстури у Photoshop.","title_ru":"Сложный материал. Библиотека. Нормаль","desc_ru":"Подключение сторонних библиотек материалов и скриптов, создание стекла, металла, пластика и кожи, карты нормалей и собственные текстуры в Photoshop."},
        {"num":"Тема 15","title":"Моделювання рослин. Корекція кольорів. Маски та шари","desc":"Моделювання рослин через Мультискаттер, робота з листям і хвоєю через карти прозорості, корекція кольору та створення масок у Photoshop.","title_ru":"Моделирование растений. Коррекция цветов. Маски и слои","desc_ru":"Моделирование растений через Мультискаттер, работа с листвой и хвоей через карты прозрачности, коррекция цвета и создание масок в Photoshop."},
        {"num":"Тема 16","title":"HDR карти. Налаштування","desc":"Підключення HDR-карт навколишнього середовища, налаштування параметрів у редакторі матеріалів та типові помилки в роботі з оточенням.","title_ru":"HDR карты. Настройка","desc_ru":"Подключение HDR-карт окружающей среды, настройка параметров в редакторе материалов и типичные ошибки в работе с окружением."},
        {"num":"Тема 17","title":"Природа. Вода. Пейзаж","desc":"Налаштування скаттерів для трави та рослин, моделювання води (річка, море, басейн), перепади висоти та створення лісового пейзажу.","title_ru":"Природа. Вода. Пейзаж","desc_ru":"Настройка скаттеров для травы и растений, моделирование воды (река, море, бассейн), перепады высоты и создание лесного пейзажа."},
        {"num":"Тема 18","title":"Освітлення. Підлога. Дах","desc":"Стандартне освітлення та Corona Light, постановка світла вдень і вночі, світлопроникність матеріалів, створення підлоги й даху для замкненого простору.","title_ru":"Освещение. Пол. Крыша","desc_ru":"Стандартное освещение и Corona Light, постановка света днём и ночью, светопроницаемость материалов, создание пола и крыши для замкнутого пространства."},
        {"num":"Тема 19","title":"Корона-рендер","desc":"Встановлення Corona Renderer, налаштування сцени та матеріалів корони, інтерактивний рендер, камера й освітлення корони, експозиція, тіні та фінальний рендеринг.","title_ru":"Corona-рендер","desc_ru":"Установка Corona Renderer, настройка сцены и материалов короны, интерактивный рендер, камера и освещение короны, экспозиция, тени и финальный рендеринг."},
        {"num":"Тема 20","title":"Камера","desc":"Створення стандартної та Corona-камери, налаштування глибини різкості та позиціонування спостерігача.","title_ru":"Камера","desc_ru":"Создание стандартной и Corona-камеры, настройка глубины резкости и позиционирования наблюдателя."},
        {"num":"Тема 21","title":"Створення реалістичних матеріалів","desc":"Підбір якісних текстур, створення мармуру, цегли та дерева, плагіни для каменю та плитки, реалістичне скло, вода та елементи екстер'єру.","title_ru":"Создание реалистичных материалов","desc_ru":"Подбор качественных текстур, создание мрамора, кирпича и дерева, плагины для камня и плитки, реалистичное стекло, вода и элементы экстерьера."},
        {"num":"Тема 22","title":"Рендеринг","desc":"Фінальні налаштування рендера, збереження сцени, корекція в момент рендерингу та пооб'єктний рендеринг.","title_ru":"Рендеринг","desc_ru":"Финальные настройки рендера, сохранение сцены, коррекция в момент рендеринга и пообъектный рендеринг."},
        {"num":"Тема 23","title":"Практикуємося з великими проєктами","desc":"Практика на великих проєктах: особняк з басейном і садом, радянський інтер'єр, а також сучасні стилі — лофт, модерн і класика.","title_ru":"Практикуемся с крупными проектами","desc_ru":"Практика на крупных проектах: особняк с бассейном и садом, советский интерьер, а также современные стили — лофт, модерн и классика."},
        {"num":"Тема 24","title":"AutoCAD. Створення плану","desc":"Знайомство з AutoCAD, налаштування інтерфейсу, інструменти лінії та полілінії, розміри й властивості, створення першого плану.","title_ru":"AutoCAD. Создание плана","desc_ru":"Знакомство с AutoCAD, настройка интерфейса, инструменты линии и полилинии, размеры и свойства, создание первого плана."},
        {"num":"Тема 25","title":"Штрихування, лінії, розміри","desc":"Типи ліній та штрихування за стандартами, розміри елементів на плані, налаштування вимірювань, масштаб і підготовка плану до імпорту.","title_ru":"Штриховка, линии, размеры","desc_ru":"Типы линий и штриховки по стандартам, размеры элементов на плане, настройка измерений, масштаб и подготовка плана к импорту."},
        {"num":"Тема 26","title":"Імпорт плану в 3ds Max","desc":"Типові проблеми при імпорті плану з AutoCAD у 3ds Max та підготовка коректного плану без помилок.","title_ru":"Импорт плана в 3ds Max","desc_ru":"Типичные проблемы при импорте плана из AutoCAD в 3ds Max и подготовка корректного плана без ошибок."},
        {"num":"Тема 27","title":"Практика в AutoCAD","desc":"Практичне креслення плану квартири та особняка з ділянкою в AutoCAD, інтер'єрні та екстер'єрні креслення.","title_ru":"Практика в AutoCAD","desc_ru":"Практическое черчение плана квартиры и особняка с участком в AutoCAD, интерьерные и экстерьерные чертежи."},
        {"num":"Тема 28","title":"Моделювання складних вікон, дверей та перегородок","desc":"Розчленування об'єктів, зміщення та копіювання, прив'язка кутів, робота з дугами та обертанням для складних вікон і перегородок.","title_ru":"Моделирование сложных окон, дверей и перегородок","desc_ru":"Расчленение объектов, смещение и копирование, привязка углов, работа с дугами и вращением для сложных окон и перегородок."},
        {"num":"Тема 29","title":"Постобробка в Photoshop","desc":"Стандартні задачі постобробки рендера та базові можливості Photoshop для фінального зображення.","title_ru":"Постобработка в Photoshop","desc_ru":"Стандартные задачи постобработки рендера и базовые возможности Photoshop для финального изображения."},
        {"num":"Тема 30","title":"Знайомство з Adobe Photoshop","desc":"Растрова та векторна графіка, колірні моделі, створення та збереження файлів у Photoshop.","title_ru":"Знакомство с Adobe Photoshop","desc_ru":"Растровая и векторная графика, цветовые модели, создание и сохранение файлов в Photoshop."},
        {"num":"Тема 31","title":"Інструменти виділення","desc":"Чарівна паличка, ласо, маска, колірний діапазон, трансформація та уточнення країв виділеної області.","title_ru":"Инструменты выделения","desc_ru":"Волшебная палочка, лассо, маска, цветовой диапазон, трансформация и уточнение краёв выделенной области."},
        {"num":"Тема 32","title":"Робота з шарами","desc":"Робота з шарами через палітру Layers, злиття та групування шарів, стилі шарів — тінь, ореол та імітація рельєфу.","title_ru":"Работа со слоями","desc_ru":"Работа со слоями через палитру Layers, слияние и группировка слоёв, стили слоёв — тень, ореол и имитация рельефа."},
        {"num":"Тема 33","title":"Корекція кольору","desc":"Корекція кольору, коригувальні шари та тонові криві Curves, перетворення фото у чорно-біле та створення складного колажу.","title_ru":"Коррекция цвета","desc_ru":"Коррекция цвета, корректирующие слои и тоновые кривые Curves, преобразование фото в чёрно-белое и создание сложного коллажа."},
        {"num":"Фінал","title":"Іспит","desc":"Захист власного портфоліо, зібраного за час навчання з практичних, курсових та дипломного проєктів.","title_ru":"Экзамен","desc_ru":"Защита собственного портфолио, собранного за время обучения из практических, курсовых и дипломного проектов."}
        ],
      });
      console.log('✅  Seeded 3d-interior course (34 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: "3D-інтер'єри, 3ds Max" });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: '3ds Max та AutoCAD' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 10, course: '3d-interior', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 12, course: '3d-interior', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 14, course: '3d-interior', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 11, course: '3d-interior', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age:  9, course: '3d-interior', phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 13, course: '3d-interior', phone: '+380506006006', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const ANIMATION_INDEX_TPL = fs.readFileSync(path.join(__dirname, '..', 'index.html'), 'utf8');
const ANIMATION_META_RU = {
  title: 'Курс 3D-интерьеров и ландшафтов (3ds Max) для подростков — My Computer Academy, обучение онлайн',
  desc:  'Курс 3D-интерьеров и ландшафтов в 3ds Max для подростков 12–18 лет онлайн. Моделирование мебели и пространства, материалы, визуализация в V-Ray/Corona. Малые группы до 5 человек. Первый урок бесплатно.',
};
app.get(['/', '/index.html'], (req, res, next) => {
  if (req.query.lang !== 'ru') return next();
  const m = ANIMATION_META_RU;
  const html = ANIMATION_INDEX_TPL
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://3dsmax.mycomputer.school';
...
app.get('/articles', (req, res) => {
  ...
  const siteUrl = 'https://3dsmax.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     '3dsmax.mycomputer.school',
    };
...
const COURSE_SLUGS = ['3d-interior'];
