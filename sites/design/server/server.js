...
const COURSE_SEED = [
  ...
  { id: 'graphic',     name: 'Графіка та ілюстрація',             emoji: '🎨', age: '6–12 років',  age_group: '6-10',  duration: '3 місяці',  lessonsCount: 24, groupSize: 5, price: 3600, color: '#ec4899', popular: false,
  ...
  { id: 'ui-ux',       name: 'UI/UX дизайн у Figma',              emoji: '📱', age: '12–18 років', age_group: '14-18', duration: '4 місяці',  lessonsCount: 32, groupSize: 5, price: 3600, color: '#06b6d4', popular: true,
  ...
  { id: 'animation',   name: 'Анімація та моушн-дизайн',          emoji: '🎬', age: '8–14 років',  age_group: '10-14', duration: '3 місяці',  lessonsCount: 24, groupSize: 5, price: 3600, color: '#f59e0b', popular: false,
  ...
  { id: '3d-interior', name: '3D-ландшафти та інтер\'єри (3ds Max)', emoji: '🏛️', age: '12–18 років', age_group: '14-18', duration: '4 місяці',  lessonsCount: 32, groupSize: 5, price: 3600, color: '#14b8a6', popular: false,
  ...
  { id: '3d-blender',  name: '3D-моделювання у Blender',          emoji: '🧊', age: '10–16 років', age_group: '10-14', duration: '4 місяці',  lessonsCount: 32, groupSize: 5, price: 3600, color: '#fb923c', popular: false,
  ...
  { id: 'drawing',     name: 'Цифровий рисунок',                  emoji: '✏️', age: '6–12 років',  age_group: '6-10',  duration: '3 місяці',  lessonsCount: 24, groupSize: 5, price: 3600, color: '#a855f7', popular: false,
  ...
  { id: 'branding',    name: 'Брендинг та логотипи',              emoji: '🏷️', age: '12–18 років', age_group: '14-18', duration: '3 місяці',  lessonsCount: 24, groupSize: 5, price: 3600, color: '#eab308', popular: false,
  ...
  { id: 'ai-design',   name: 'AI-дизайн (нейромережі)',           emoji: '🤖', age: '12–18 років', age_group: '14-18', duration: '2 місяці',  lessonsCount: 16, groupSize: 5, price: 3600, color: '#10b981', popular: false,
...
const COURSE_SEO_TEXTS = {
  pc:          'Базовий курс роботи з комп\'ютером для дітей у Дніпрі від школи дизайну My Computer Academy. Курс для дітей 6–10 років: клавіатура, миша, файлова система Windows, Word, Paint, безпека в інтернеті, захист від шкідливих сайтів. Швидкий набір тексту сліпим методом. Ідеальний старт у світ цифрових технологій та майбутнього дизайну. Онлайн та офлайн у Дніпрі, мала група до 5 учнів, 16 занять за 2 місяці. Перший урок безкоштовно.',
  graphic:     'Курс графіки та ілюстрації для дітей у Дніпрі від школи дизайну My Computer Academy. Учні 6–12 років вивчають растрову та векторну графіку в Photoshop та Illustrator: цифровий малюнок, кольорознавство, робота з шарами та композицією. Курс для юних художників і майбутніх дизайнерів. Власна ілюстрація у фіналі. Онлайн та офлайн у Дніпрі, мала група до 5 учнів, 24 уроки за 3 місяці. Перший урок безкоштовно.',
