...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (ai-design.mycomputer.school)',
        heading: 'Курс AI-дизайну (нейромережі) для підлітків — My Computer Academy',
        text: 'Курс AI-дизайну для підлітків 12–18 років у My Computer Academy: Midjourney, prompt engineering, нейромережі в дизайні. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс AI-дизайну триває 9 місяців при 1–2 заняттях на тиждень — 8 тем від основ нейромереж до готового AI-арт проєкту в портфоліо.', ru:'Полный курс AI-дизайна длится 9 месяцев при 1–2 занятиях в неделю — 8 тем от основ нейросетей до готового AI-арт проекта в портфолио.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        id: 'ai-design', name: "AI-дизайн (нейромережі)", name_ru: "AI-дизайн (нейросети)", emoji: "🤖",
        ...
        description_ru: "Создание изображений нейросетями: prompt engineering, Midjourney и интеграция AI в дизайнерский процесс.",
        curriculum: [
        {"num":"Тема 1","title":"Вступ до AI в дизайні","desc":"Огляд нейромереж для зображень, можливості та обмеження, етика використання.","title_ru":"Введение в AI в дизайне","desc_ru":"Обзор нейросетей для изображений, возможности и ограничения, этика использования."},
        {"num":"Тема 2","title":"Основи Midjourney","desc":"Реєстрація, перші запити (prompts), базові параметри команд.","title_ru":"Основы Midjourney","desc_ru":"Регистрация, первые запросы (prompts), базовые параметры команд."},
        {"num":"Тема 3","title":"Prompt engineering","desc":"Структура ефективного запиту, стилі, референси, ітеративне покращення результату.","title_ru":"Prompt engineering","desc_ru":"Структура эффективного запроса, стили, референсы, итеративное улучшение результата."},
        {"num":"Тема 4","title":"Композиція та стиль через AI","desc":"Керування ракурсом, освітленням, художнім стилем через текстовий запит.","title_ru":"Композиция и стиль через AI","desc_ru":"Управление ракурсом, освещением, художественным стилем через текстовый запрос."},
        {"num":"Тема 5","title":"AI для персонажів та сцен","desc":"Генерація узгоджених персонажів, консистентність стилю у серії зображень.","title_ru":"AI для персонажей и сцен","desc_ru":"Генерация согласованных персонажей, консистентность стиля в серии изображений."},
        {"num":"Тема 6","title":"Пост-обробка AI-зображень","desc":"Доопрацювання в Photoshop, виправлення артефактів, фінальне оформлення.","title_ru":"Пост-обработка AI-изображений","desc_ru":"Доработка в Photoshop, исправление артефактов, финальное оформление."},
        {"num":"Тема 7","title":"AI в робочому процесі дизайнера","desc":"Генерація референсів, мудбордів, швидких концептів для клієнтів.","title_ru":"AI в рабочем процессе дизайнера","desc_ru":"Генерация референсов, мудбордов, быстрых концептов для клиентов."},
        {"num":"Фінал","title":"AI-арт проєкт у портфоліо","desc":"Серія зображень в єдиному стилі, створена за допомогою AI-інструментів.","title_ru":"AI-арт проект в портфолио","desc_ru":"Серия изображений в едином стиле, созданная с помощью AI-инструментов."}
        ],
      });
      console.log('✅  Seeded ai-design course (8 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'AI-дизайн, Midjourney' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'AI-дизайн, prompt engineering' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 14, course: 'ai-design', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 15, course: 'ai-design', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 17, course: 'ai-design', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 13, course: 'ai-design', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age: 12, course: 'ai-design', phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 16, course: 'ai-design', phone: '+380506006006', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const ANIMATION_META_RU = {
  title: 'Курс AI-дизайна (нейросети) для подростков — My Computer Academy, обучение онлайн',
  desc:  'Курс AI-дизайна для подростков 12–18 лет онлайн. Midjourney, prompt engineering, нейросети в дизайне. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://ai-design.mycomputer.school';
...
app.get('/articles', (req, res) => {
  ...
  const siteUrl = 'https://ai-design.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'ai-design.mycomputer.school',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'AI-дизайн (лендинг)', notes: 'Заявка з ai-design.mycomputer.school' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  <meta property="og:image" content="https://ai-design.mycomputer.school/og-image.png?v=2"/>
