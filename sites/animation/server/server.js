...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (animation.mycomputer.school)',
        heading: 'Курс анімації та моушн-дизайну для дітей — My Computer Academy',
        text: 'Курс анімації та моушн-дизайну для дітей 8–14 років у My Computer Academy: After Effects, анімація персонажів, моушн-графіка для соцмереж. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо дітей від 8 років — вік, коли вже комфортно освоювати After Effects та принципи анімації.', ru:'Принимаем детей от 8 лет — возраст, когда уже комфортно осваивать After Effects и принципы анимации.' } },
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс анімації та моушн-дизайну триває 9 місяців при 1–2 заняттях на тиждень — 8 тем від основ анімації до власного анімованого ролика.', ru:'Полный курс анимации и моушн-дизайна длится 9 месяцев при 1–2 занятиях в неделю — 8 тем от основ анимации до собственного анимированного ролика.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        id: 'animation', name: "Анімація та моушн-дизайн", name_ru: "Анимация и моушн-дизайн", emoji: "🎬",
        age: "8–14 років", age_group: "8-14",
        duration: "9 місяців", lessonsCount: 72,
        ...
        description_ru: "Оживляем графику: анимация персонажей, текста и баннеров. От первого кадра до готового анимированного ролика.",
        curriculum: [
        {"num":"Тема 1","title":"Основи анімації","desc":"Принципи руху (12 принципів анімації), таймінг, easing — фундамент будь-якої анімації.","title_ru":"Основы анимации","desc_ru":"Принципы движения (12 принципов анимации), тайминг, easing — фундамент любой анимации."},
        {"num":"Тема 2","title":"Знайомство з After Effects","desc":"Інтерфейс, шари, таймлайн, ключові кадри — перші кроки в анімації.","title_ru":"Знакомство с After Effects","desc_ru":"Интерфейс, слои, таймлайн, ключевые кадры — первые шаги в анимации."},
        {"num":"Тема 3","title":"Анімація тексту","desc":"Анімовані написи, ефекти появи/зникнення тексту, типографічна анімація.","title_ru":"Анимация текста","desc_ru":"Анимированные надписи, эффекты появления/исчезновения текста, типографическая анимация."},
        {"num":"Тема 4","title":"Анімація персонажів","desc":"Rigging простих персонажів, оживлення статичної графіки, walk-цикли.","title_ru":"Анимация персонажей","desc_ru":"Rigging простых персонажей, оживление статичной графики, walk-циклы."},
        {"num":"Тема 5","title":"Моушн-графіка для банерів","desc":"Анімовані банери, рекламні ролики, адаптація під соцмережі.","title_ru":"Моушн-графика для баннеров","desc_ru":"Анимированные баннеры, рекламные ролики, адаптация под соцсети."},
        {"num":"Тема 6","title":"Анімація логотипів","desc":"Оживлення бренд-елементів, інтро-заставки, короткі sting-анімації.","title_ru":"Анимация логотипов","desc_ru":"Оживление бренд-элементов, интро-заставки, короткие sting-анимации."},
        {"num":"Тема 7","title":"Звук та синхронізація","desc":"Додавання звукових ефектів та музики, синхронізація з рухом на екрані.","title_ru":"Звук и синхронизация","desc_ru":"Добавление звуковых эффектов и музыки, синхронизация с движением на экране."},
        {"num":"Тема 8","title":"Експорт та формати","desc":"Підготовка анімації під Instagram/TikTok/YouTube, оптимізація файлів.","title_ru":"Экспорт и форматы","desc_ru":"Подготовка анимации под Instagram/TikTok/YouTube, оптимизация файлов."},
        {"num":"Фінал","title":"Власний анімований ролик","desc":"Створення повноцінного анімованого відео від сценарію до готового експорту.","title_ru":"Собственный анимированный ролик","desc_ru":"Создание полноценного анимированного видео от сценария до готового экспорта."}
        ],
      });
      console.log('✅  Seeded animation course (9 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'Анімація, After Effects' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'Моушн-дизайн для наймолодших' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 10, course: 'animation', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 12, course: 'animation', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 14, course: 'animation', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 11, course: 'animation', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age:  9, course: 'animation', phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 13, course: 'animation', phone: '+380506006006', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const ANIMATION_META_RU = {
  title: 'Курс анимации и моушн-дизайна для детей — My Computer Academy, обучение онлайн',
  desc:  'Курс анимации и моушн-дизайна для детей 8–14 лет онлайн. After Effects с нуля: анимация персонажей, текста, моушн-графика для соцсетей. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://animation.mycomputer.school';
...
app.get('/articles', (req, res) => {
  ...
  const siteUrl = 'https://animation.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'animation.mycomputer.school',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Анімація (лендинг)', notes: 'Заявка з animation.mycomputer.school' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  <meta property="og:image" content="https://animation.mycomputer.school/og-image.png?v=2"/>
