...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (blender.mycomputer.school)',
        heading: 'Курс 3D-моделювання у Blender для дітей — My Computer Academy',
        text: 'Курс 3D-моделювання у безкоштовному Blender для дітей 10–16 років у My Computer Academy: моделювання, матеріали, освітлення, рендер. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо дітей від 10 років — вік, коли вже комфортно освоювати інтерфейс Blender та принципи 3D-моделювання.', ru:'Принимаем детей от 10 лет — возраст, когда уже комфортно осваивать интерфейс Blender и принципы 3D-моделирования.' } },
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс 3D-моделювання у Blender триває 10 місяців при 1–2 заняттях на тиждень — 9 тем від знайомства з Blender до готової 3D-моделі для портфоліо.', ru:'Полный курс 3D-моделирования в Blender длится 10 месяцев при 1–2 занятиях в неделю — 9 тем от знакомства с Blender до готовой 3D-модели для портфолио.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        id: '3d-blender', name: "3D-моделювання у Blender", name_ru: "3D-моделирование в Blender", emoji: "🧊",
        age: "10–16 років", age_group: "10-16",
        duration: "10 місяців", lessonsCount: 80,
        ...
        description_ru: "Бесплатный и мощный Blender: моделирование, материалы, освещение и рендер собственных 3D-объектов.",
        curriculum: [
        {"num":"Тема 1","title":"Знайомство з Blender","desc":"Інтерфейс, навігація, основні інструменти виділення та трансформації.","title_ru":"Знакомство с Blender","desc_ru":"Интерфейс, навигация, основные инструменты выделения и трансформации."},
        {"num":"Тема 2","title":"Моделювання від примітивів","desc":"Extrude, Loop Cut, Bevel — створення об'єктів з базових форм.","title_ru":"Моделирование от примитивов","desc_ru":"Extrude, Loop Cut, Bevel — создание объектов из базовых форм."},
        {"num":"Тема 3","title":"Моделювання персонажів","desc":"Base mesh, скульптинг облич та тіл, топологія для подальшої анімації.","title_ru":"Моделирование персонажей","desc_ru":"Base mesh, скульптинг лиц и тел, топология для дальнейшей анимации."},
        {"num":"Тема 4","title":"Матеріали та шейдери","desc":"Node Editor, PBR-матеріали, текстурування об'єктів.","title_ru":"Материалы и шейдеры","desc_ru":"Node Editor, PBR-материалы, текстурирование объектов."},
        {"num":"Тема 5","title":"UV-розгортка","desc":"Unwrap об'єктів, підготовка текстурних карт, seams та islands.","title_ru":"UV-развёртка","desc_ru":"Unwrap объектов, подготовка текстурных карт, seams и islands."},
        {"num":"Тема 6","title":"Освітлення та World","desc":"Типи світла в Blender, HDRI-оточення, налаштування атмосфери сцени.","title_ru":"Освещение и World","desc_ru":"Типы света в Blender, HDRI-окружение, настройка атмосферы сцены."},
        {"num":"Тема 7","title":"Рендер у Cycles/Eevee","desc":"Порівняння движків, налаштування якості та часу рендеру.","title_ru":"Рендер в Cycles/Eevee","desc_ru":"Сравнение движков, настройка качества и времени рендера."},
        {"num":"Тема 8","title":"Основи анімації в Blender","desc":"Ключові кадри, timeline, прості цикли руху об'єктів.","title_ru":"Основы анимации в Blender","desc_ru":"Ключевые кадры, timeline, простые циклы движения объектов."},
        {"num":"Тема 9","title":"Rigging та Armature","desc":"Створення простого скелета для персонажа, зв'язування з мешем.","title_ru":"Rigging и Armature","desc_ru":"Создание простого скелета для персонажа, связывание с мешем."},
        {"num":"Фінал","title":"Готова 3D-модель для портфоліо","desc":"Повний цикл від моделювання до фінального рендеру власного об'єкта чи персонажа.","title_ru":"Готовая 3D-модель для портфолио","desc_ru":"Полный цикл от моделирования до финального рендера собственного объекта или персонажа."}
        ],
      });
      console.log('✅  Seeded 3d-blender course (10 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: '3D-моделювання, Blender' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'Blender для наймолодших' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 10, course: '3d-blender', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 12, course: '3d-blender', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 14, course: '3d-blender', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        ...
        { name: 'Данило Романів',   age:  9, course: '3d-blender', phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 13, course: '3d-blender', phone: '+380506006006', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const ANIMATION_META_RU = {
  title: 'Курс 3D-моделирования в Blender для детей — My Computer Academy, обучение онлайн',
  desc:  'Курс 3D-моделирования в бесплатном Blender для детей 10–16 лет онлайн. Моделирование, материалы, освещение, рендер. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://blender.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'blender.mycomputer.school',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || '3D-Blender (лендинг)', notes: 'Заявка з blender.mycomputer.school' }),
      }).catch(() => {});
    }
