...
const CONTENT_SEED = {
  pricing: [
    {
      ...
      features: [
        { ua: '18 місяців, один раз на тиждень, 90 хв', ru: '18 месяцев, один раз в неделю, 90 мин' },
    ...
    },
    {
      ...
      features: [
        { ua: '18 місяців, два рази на тиждень, по 90 хв', ru: '18 месяцев, два раза в неделю, по 90 минут' },
        { ua: 'Мала група до 5 дітей',                       ru: 'Малая группа до 5 детей' },
        { ua: 'Доступ до матеріалів назавжди',               ru: 'Доступ к материалам навсегда' },
      ],
  ...
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо дітей від 10 років — вік, коли вже комфортно читати й друкувати код. Для молодшої групи (10–14) — основи HTML/CSS/JS, для старшої (14–18) — сучасний стек і React. Конкретний рівень підберемо на безкоштовній консультації.', ru:'Принимаем детей от 10 лет — возраст, когда уже комфортно читать и печатать код. Для младшей группы (10–14) — основы HTML/CSS/JS, для старшей (14–18) — современный стек и React. Конкретный уровень подберём на бесплатной консультации.' } },
    ...
    { id:6, question:{ ua:'Скільки тривають курси?',            ru:'Сколько длятся курсы?' },                    answer:{ ua:'Кожен курс триває 18 місяців при 1–2 заняттях на тиждень. Можна пройти обидва рівні послідовно — Frontend Старт, а потім Frontend Pro.', ru:'Каждый курс длится 18 месяцев при 1–2 занятиях в неделю. Можно пройти оба уровня последовательно — Frontend Старт, а потом Frontend Pro.' } },
  ...
  try {
    ...
    if (!coursesDb.getAll().some(c => c.id === 'frontend-10-14')) {
      ...
      coursesDb.create({ id: 'frontend-10-14', name: 'Frontend Старт: перший сайт', name_ru: 'Frontend Старт: первый сайт', emoji: '🧱', age: '10–14 років', age_group: '10-14', description: 'Перший крок у веб-розробку: власна сторінка з нуля до публікації', description_ru: 'Первый шаг в веб-разработку: собственная страница с нуля до публикации', lessonsCount: 156, ...shared, curriculum: [
        ...
        { num: '03', title: 'Форми та поля вводу', desc: 'Текстові поля, кнопки, чекбокси, select — як сайт приймає дані від користувача.', title_ru: 'Формы и поля ввода', desc_ru: 'Текстовые поля, кнопки, чекбоксы, select — как сайт принимает данные от пользователя.' },
        { num: '04', title: 'Таблиці даних', desc: 'Рядки, колонки, об\'єднання комірок — оформлюємо розклад або таблицю результатів.', title_ru: 'Таблицы данных', desc_ru: 'Строки, колонки, объединение ячеек — оформляем расписание или таблицу результатов.' },
        { num: '05', title: 'CSS3: кольори та шрифти', desc: 'Синтаксис CSS, кольорові моделі, підключення шрифтів. Сторінка починає виглядати як сайт.', title_ru: 'CSS3: цвета и шрифты', desc_ru: 'Синтаксис CSS, цветовые модели, подключение шрифтов. Страница начинает выглядеть как сайт.' },
        { num: '06', title: 'Box model та відступи', desc: 'Margin, padding, border — як браузер рахує розмір і простір навколо кожного блока.', title_ru: 'Box model и отступы', desc_ru: 'Margin, padding, border — как браузер считает размер и пространство вокруг каждого блока.' },
        { num: '07', title: 'Фони та зображення', desc: 'Формати JPEG/PNG/SVG, фонові зображення, градієнти — картинки на сторінці виглядають акуратно.', title_ru: 'Фоны и изображения', desc_ru: 'Форматы JPEG/PNG/SVG, фоновые изображения, градиенты — картинки на странице выглядят аккуратно.' },
        { num: '08', title: 'Шрифти та іконки', desc: 'Google Fonts, іконкові шрифти — типографіка, яка робить сайт впізнаваним.', title_ru: 'Шрифты и иконки', desc_ru: 'Google Fonts, иконочные шрифты — типографика, которая делает сайт узнаваемым.' },
        { num: '09', title: 'Flexbox', desc: 'Сучасне вирівнювання блоків без таблиць — картки, меню, центрування.', title_ru: 'Flexbox', desc_ru: 'Современное выравнивание блоков без таблиц — карточки, меню, центрирование.' },
        { num: '10', title: 'CSS Grid', desc: 'Сітки для складних макетів: галереї, розкладки в кілька колонок.', title_ru: 'CSS Grid', desc_ru: 'Сетки для сложных макетов: галереи, раскладки в несколько колонок.' },
        { num: '11', title: 'Навігація та посилання', desc: 'Меню сайту, якірні посилання, відносні й абсолютні шляхи між сторінками.', title_ru: 'Навигация и ссылки', desc_ru: 'Меню сайта, якорные ссылки, относительные и абсолютные пути между страницами.' },
        { num: '12', title: 'Адаптивність', desc: 'Media queries, mobile-first — сайт виглядає добре і на телефоні, і на моніторі.', title_ru: 'Адаптивность', desc_ru: 'Media queries, mobile-first — сайт хорошо выглядит и на телефоне, и на мониторе.' },
        { num: '13', title: 'Псевдокласи та прості анімації', desc: ':hover, :focus, transition — кнопки й посилання, які реагують на дії користувача.', title_ru: 'Псевдоклассы и простые анимации', desc_ru: ':hover, :focus, transition — кнопки и ссылки, которые реагируют на действия пользователя.' },
        { num: '14', title: 'Bootstrap: готові компоненти', desc: 'CSS-фреймворк — кнопки, картки та сітка, які збирають сторінку швидше.', title_ru: 'Bootstrap: готовые компоненты', desc_ru: 'CSS-фреймворк — кнопки, карточки и сетка, которые собирают страницу быстрее.' },
        { num: '15', title: 'JavaScript: змінні та логіка', desc: 'Змінні, умови, цикли — вчимо сторінку "думати".', title_ru: 'JavaScript: переменные и логика', desc_ru: 'Переменные, условия, циклы — учим страницу &quot;думать&quot;.' },
        { num: '16', title: 'DOM та події', desc: 'Клік, ховер, введення в поле. Перший інтерактив: кнопки, що реагують.', title_ru: 'DOM и события', desc_ru: 'Клик, ховер, ввод в поле. Первый интерактив: кнопки, которые реагируют.' },
        { num: '17', title: 'Локальне збереження даних', desc: 'localStorage — список справ або нотатки, які не зникають після перезавантаження сторінки.', title_ru: 'Локальное сохранение данных', desc_ru: 'localStorage — список дел или заметки, которые не исчезают после перезагрузки страницы.' },
        { num: '18', title: 'Міні-проект: фотогалерея', desc: 'Галерея із сіткою, підписами та ефектом при наведенні — перший самостійний проект.', title_ru: 'Мини-проект: фотогалерея', desc_ru: 'Галерея с сеткой, подписями и эффектом при наведении — первый самостоятельный проект.' },
        { num: '19', title: 'Міні-проект: калькулятор і перемикач теми', desc: 'Робочий калькулятор та світла/темна тема на JavaScript.', title_ru: 'Мини-проект: калькулятор и переключатель темы', desc_ru: 'Рабочий калькулятор и светлая/тёмная тема на JavaScript.' },
        { num: '20', title: 'Git та GitHub Pages', desc: 'Контроль версій, публікація сайту — справжня адреса в інтернеті.', title_ru: 'Git и GitHub Pages', desc_ru: 'Контроль версий, публикация сайта — настоящий адрес в интернете.' },
        { num: '🚀', title: 'Фінальний проект: сайт-портфоліо', desc: 'Особиста сторінка-портфоліо з кількох секцій, опублікована на GitHub Pages.', title_ru: 'Финальный проект: сайт-портфолио', desc_ru: 'Личная страница-портфолио из нескольких секций, опубликованная на GitHub Pages.' },
      ]});
      coursesDb.create({ id: 'frontend-14-18', name: 'Frontend Pro: сучасна веб-розробка', name_ru: 'Frontend Pro: современная веб-разработка', emoji: '⚛️', age: '14–18 років', age_group: '14-18', description: 'Сучасний JS, React та деплой — портфоліо-проект як у реального розробника', description_ru: 'Современный JS, React и деплой — портфолио-проект как у настоящего разработчика', lessonsCount: 156, ...shared, curriculum: [
        ...
        { num: '04', title: 'TypeScript: типізація JS', desc: 'Навіщо потрібні типи, interface, базова типізація функцій та об\'єктів.', title_ru: 'TypeScript: типизация JS', desc_ru: 'Зачем нужны типы, interface, базовая типизация функций и объектов.' },
        { num: '05', title: 'CSS-архітектура', desc: 'БЕМ-методологія, CSS-змінні, основи Sass — стилі, які легко підтримувати.', title_ru: 'CSS-архитектура', desc_ru: 'БЭМ-методология, CSS-переменные, основы Sass — стили, которые легко поддерживать.' },
        { num: '06', title: 'Просунутий CSS: анімації та трансформації', desc: 'Keyframes, transform, transition timing — плавні й ефектні інтерфейси.', title_ru: 'Продвинутый CSS: анимации и трансформации', desc_ru: 'Keyframes, transform, transition timing — плавные и эффектные интерфейсы.' },
        { num: '07', title: 'Доступна верстка', desc: 'Семантика, основи a11y — сайт, зручний для всіх користувачів.', title_ru: 'Доступная вёрстка', desc_ru: 'Семантика, основы a11y — сайт, удобный для всех пользователей.' },
        { num: '08', title: 'Інструменти розробника', desc: 'npm, Vite — збірка проекту як у реальній команді.', title_ru: 'Инструменты разработчика', desc_ru: 'npm, Vite — сборка проекта как в настоящей команде.' },
        { num: '09', title: 'Вступ до React', desc: 'Компоненти, props, JSX — перший інтерфейс на React.', title_ru: 'Введение в React', desc_ru: 'Компоненты, props, JSX — первый интерфейс на React.' },
        { num: '10', title: 'React: хуки', desc: 'useState, useEffect, списки та форми — інтерактивний застосунок.', title_ru: 'React: хуки', desc_ru: 'useState, useEffect, списки и формы — интерактивное приложение.' },
        { num: '11', title: 'React Router: багатосторінковий застосунок', desc: 'Маршрутизація між сторінками без перезавантаження — справжній SPA.', title_ru: 'React Router: многостраничное приложение', desc_ru: 'Маршрутизация между страницами без перезагрузки — настоящий SPA.' },
        { num: '12', title: 'Форми та валідація в React', desc: 'Керовані поля вводу, перевірка даних, повідомлення про помилки.', title_ru: 'Формы и валидация в React', desc_ru: 'Управляемые поля ввода, проверка данных, сообщения об ошибках.' },
        { num: '13', title: 'Управління станом: Context API', desc: 'Глобальний стан застосунку без бібліотек — тема, користувач, кошик.', title_ru: 'Управление состоянием: Context API', desc_ru: 'Глобальное состояние приложения без библиотек — тема, пользователь, корзина.' },
        { num: '14', title: 'Основи Node.js та Express', desc: 'Простий backend-сервер — фронтенд починає розмовляти зі своїм власним API.', title_ru: 'Основы Node.js и Express', desc_ru: 'Простой backend-сервер — фронтенд начинает общаться со своим собственным API.' },
        { num: '15', title: 'Бази даних: перше знайомство', desc: 'Як і де зберігаються дані застосунку — просте знайомство з базами та REST.', title_ru: 'Базы данных: первое знакомство', desc_ru: 'Как и где хранятся данные приложения — простое знакомство с базами и REST.' },
        { num: '16', title: 'Тестування: перші кроки', desc: 'Навіщо потрібні тести, базові перевірки компонентів на Jest.', title_ru: 'Тестирование: первые шаги', desc_ru: 'Зачем нужны тесты, базовые проверки компонентов на Jest.' },
        { num: '17', title: 'Git у команді', desc: 'Branches, pull request, злиття змін — робота як у справжній розробницькій команді.', title_ru: 'Git в команде', desc_ru: 'Branches, pull request, слияние изменений — работа как в настоящей команде разработки.' },
        { num: '18', title: 'Оптимізація продуктивності', desc: 'Lazy loading, code splitting — застосунок, який швидко завантажується.', title_ru: 'Оптимизация производительности', desc_ru: 'Lazy loading, code splitting — приложение, которое быстро загружается.' },
        { num: '19', title: 'Основи SEO та швидкості', desc: 'Чому сайт вантажиться швидко і його знаходить Google — базові принципи.', title_ru: 'Основы SEO и скорости', desc_ru: 'Почему сайт загружается быстро и его находит Google — базовые принципы.' },
        { num: '20', title: 'Деплой проекту', desc: 'Публікація на Netlify/Vercel, власний домен.', title_ru: 'Деплой проекта', desc_ru: 'Публикация на Netlify/Vercel, собственный домен.' },
        { num: '21', title: 'Командний проект', desc: 'Розробка сайту в парі: розподіл задач, код-рев\'ю.', title_ru: 'Командный проект', desc_ru: 'Разработка сайта в паре: распределение задач, код-ревью.' },
        { num: '🚀', title: 'Фінальний проект для портфоліо', desc: 'Повноцінний SPA-застосунок на React з власним API, задеплоєний у продакшн.', title_ru: 'Финальный проект для портфолио', desc_ru: 'Полноценное SPA-приложение на React с собственным API, задеплоенное в продакшн.' },
      ]});
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'Frontend, JavaScript, React' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'HTML/CSS, JS для підлітків' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 11, course: 'frontend-10-14', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 13, course: 'frontend-10-14', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 16, course: 'frontend-14-18', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 12, course: 'frontend-10-14', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age: 15, course: 'frontend-14-18', phone: '+380505005005', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 14, course: 'frontend-10-14', phone: '+380506006006', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
app.get(['/', '/index.html'], (req, res, next) => {
  ...
  const m = FRONTEND_META_RU;
  const html = FRONTEND_INDEX_TPL
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://frontend.mycomputer.education';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'frontend.mycomputer.education',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Веб-розробка (лендинг)', notes: 'Заявка з frontend.mycomputer.education' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  const html = ARTICLE_HTML_TPL
    ...
    .replace('<meta name="description" id="pageDesc" content="Корисні статті про веб-розробку для дітей від My Computer Academy"/>',
             `<meta name="description" id="pageDesc" content="${escHtml(excerpt) || 'Корисні статті про веб-розробку для дітей від My Computer Academy'}"/>
...
// The flagship course page duplicates this landing's homepage (same topic, same
// intent), so it canonicalizes to "/" instead of competing with it.
const PRIMARY_COURSE_ID = 'web';
