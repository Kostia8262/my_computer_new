    ...
    pages: [
      {
        ...
        text: 'Курс розробки ігор у Roblox Studio для дітей 7–14 років у My Computer Academy: мова Lua, 3D-світи, публікація власної гри. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку починають курс Roblox Studio?', ru:'С какого возраста начинают курс Roblox Studio?' }, answer:{ ua:'Roblox Studio — для дітей від 7 до 14 років. Для 9–11 — будуємо ігровий світ та перші скрипти на Lua. Для 11–14 — DataStore, монетизація та публікація власної гри. Дитина публікує свою гру вже в середині курсу!', ru:'Roblox Studio — для детей от 7 до 14 лет. Для 9–11 — строим игровой мир и первые скрипты на Lua. Для 11–14 — DataStore, монетизация и публикация собственной игры. Ребёнок публикует свою игру уже в середине курса!' } },
...
(function seedTestData() {
  try {
    ...
    if (!coursesDb.getAll().some(c => c.id === 'roblox-9-11')) {
      ...
      coursesDb.create({ id: 'roblox-9-11', name: 'Roblox Старт → Будівник', name_ru: 'Roblox Старт → Строитель', emoji: '🌍', age: '7–11 років', age_group: '6-10', description: 'Від першого об\'єкта до власної публічної гри з механіками', description_ru: 'От первого объекта до собственной публичной игры с механиками', lessonsCount: 31, ...shared, curriculum: [
...
const ROBLOX_META_RU = {
  ...
  desc:  'Курс Roblox Studio для детей 7–14 лет онлайн. Разработка игр в Roblox: скриптинг на Lua, 3D-дизайн, публикация игры для миллионов игроков. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
const PRIMARY_COURSE_ID = 'roblox';
