...
const COURSE_SEED = [
  ...
  { id: 'ui-ux',     name: 'UI/UX дизайн у Figma',              emoji: '📱', age: '12–18 років', age_group: '14-18', duration: '12 місяців', lessonsCount: 96, groupSize: 5, price: 3600, color: '#06b6d4', popular: false,
    description: 'Проєктування інтерфейсів сайтів і застосунків у Figma — від першого макета до інтерактивного прототипу.',
    features: [{ua:'✓ Figma: фрейми, компоненти, Auto Layout', ru:'✓ Figma: фреймы, компоненты, Auto Layout'},{ua:'✓ UX-дослідження та прототипування', ru:'✓ UX-исследования и прототипирование'},{ua:'✓ Повний дизайн застосунку у фіналі', ru:'✓ Полный дизайн приложения в финале'}] },
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc:  ["'self'", "https://www.google-analytics.com", "https://analytics.google.com", "https://stats.g.doubleclick.net", "https://*.contentsquare.net", "https://mycomputer.school", "https://webdesign.mycomputer.education", "https://python.mycomputer.education", "https://minecraft.mycomputer.education", "https://roblox.mycomputer.education"],
      frameSrc:       ["'none'"],
      objectSrc:      ["'none'"],
...
const COURSE_SEO_DESCS = {
  ...
  'ui-ux':   'Курс UI/UX дизайну у Figma для підлітків 12–18 років. Проєктування сайтів і застосунків, прототипування, портфоліо. Онлайн та офлайн у малих групах до 5 учнів.',
};
...
const COURSE_SEO_TEXTS = {
  ...
  'ui-ux':   'Курс UI/UX дизайну у Figma для підлітків у Дніпрі від My Computer Academy. Учні 12–18 років вчаться проєктувати інтерфейси сайтів і застосунків: від дослідження користувача та прототипу до готового дизайну в Figma. Auto Layout, компоненти, дизайн-система, презентація проєкту замовнику. У фіналі — власне портфоліо. Онлайн та офлайн у Дніпрі, мала група до 5 учнів, 96 занять за 12 місяців. Перший урок безкоштовно.',
};
