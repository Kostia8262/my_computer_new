...
const CONTENT_SEED = {
  ...
  faq: [
    { id:1, question:{ ua:'З якого віку починають курс Minecraft Education?', ru:'С какого возраста начинают курс Minecraft?' }, answer:{ ua:'Minecraft Education — для дітей від 8 до 14 років. Для 8–10 — Code Builder та алгоритми агента у Minecraft Education. Для 10–14 — Python + mcpi, будуємо кодом та розробляємо власні міні-ігри. Ідеальний старт для дитини, яка полюбляє Minecraft!', ru:'Minecraft Education — для детей от 8 до 14 лет. Для 8–10 — Code Builder и алгоритмы агента в Minecraft Education. Для 10–14 — Python + mcpi, строим кодом и разрабатываем мини-игры. Идеальный старт для ребёнка, который любит Minecraft!' } },
...
(function seedTestData() {
  try {
    ...
    if (!coursesDb.getAll().some(c => c.id === 'minecraft-8-10')) {
      const shared = { duration: '6 місяців', groupSize: 5, price: 3600, color: '#22c55e', active: true };
      coursesDb.create({ id: 'minecraft-8-10', name: 'Minecraft Старт', name_ru: 'Minecraft Старт', emoji: '⛏️', age: '8–10 років', age_group: '8-10', description: '30 занять · Education Edition: агент, Code Builder, Redstone, командна міні-гра, фінальний проект', description_ru: '30 занятий · Education Edition: агент, Code Builder, Redstone, командная мини-игра, финальный проект', lessonsCount: 30, ...shared, curriculum: [
        ...
        { num: '17', title: 'NPC та Command Blocks', desc: 'Розмова з NPC, /say, /tp через блоки команд — перше знайомство з командами гри.', title_ru: 'NPC и Command Blocks', desc_ru: 'Разговор с NPC, /say, /tp через командные блоки — первое знакомство с командами игры.' },
        { num: '18', title: 'Спавн мобів та безпечні ферми', desc: '/summon, огородження, ловчі ями — власна ферма досвіду без ризику для гравця.', title_ru: 'Спавн мобов и безопасные фермы', desc_ru: '/summon, ограждения, ловчие ямы — собственная ферма опыта без риска для игрока.' },
        { num: '19', title: 'Біоми та телепортація', desc: 'Дослідження світу, портали, пошук рідкісних структур — орієнтування на великих відстанях.', title_ru: 'Биомы и телепортация', desc_ru: 'Исследование мира, порталы, поиск редких структур — ориентирование на больших расстояниях.' },
        { num: '20', title: 'Structure Block: копіювання будівель', desc: 'Зберігаємо готову споруду і вставляємо копію в іншому місці одним кліком.', title_ru: 'Structure Block: копирование построек', desc_ru: 'Сохраняем готовую постройку и вставляем копию в другом месте одним кликом.' },
        { num: '21', title: 'Освітлення та атмосфера', desc: 'Факели, ліхтарі, скляні блоки — як світло змінює настрій локації.', title_ru: 'Освещение и атмосфера', desc_ru: 'Факелы, фонари, стеклянные блоки — как свет меняет настроение локации.' },
        { num: '22', title: 'Логічні ворота на Redstone', desc: 'AND/OR/NOT-комбінації сигналів — просунута автоматика для дверей і пасток.', title_ru: 'Логические вентили на Redstone', desc_ru: 'AND/OR/NOT-комбинации сигналов — продвинутая автоматика для дверей и ловушек.' },
        { num: '23', title: 'Вагонетки та рейкові маршрути', desc: 'Будуємо автоматичну залізницю зі станціями між частинами світу.', title_ru: 'Вагонетки и рельсовые маршруты', desc_ru: 'Строим автоматическую железную дорогу со станциями между частями мира.' },
        { num: '24', title: 'Вода, лава та безпечні ліфти', desc: 'Водяні ліфти, керована лава, безпечні спуски — механіки на основі рідин.', title_ru: 'Вода, лава и безопасные лифты', desc_ru: 'Водяные лифты, управляемая лава, безопасные спуски — механики на основе жидкостей.' },
        { num: '25', title: 'Дизайн інтер\'єру', desc: 'Меблі з блоків, кімнати, декор — робимо будівлю затишною зсередини.', title_ru: 'Дизайн интерьера', desc_ru: 'Мебель из блоков, комнаты, декор — делаем постройку уютной изнутри.' },
        { num: '26', title: 'Командна міні-гра: захоплення прапора', desc: 'Правила, таймер, рахунок — перша багатокористувацька гра власного дизайну.', title_ru: 'Командная мини-игра: захват флага', desc_ru: 'Правила, таймер, счёт — первая многопользовательская игра собственного дизайна.' },
        { num: '27', title: 'Планування фінального проекту', desc: 'Кожен обирає тему: місто, замок, острів, парк — малюємо план і розбиваємо на частини.', title_ru: 'Планирование финального проекта', desc_ru: 'Каждый выбирает тему: город, замок, остров, парк — рисуем план и разбиваем на части.' },
        { num: '28', title: 'Фінальний проект, частина 1', desc: 'Основа, каркас, головна споруда — реалізуємо перший блок плану.', title_ru: 'Финальный проект, часть 1', desc_ru: 'Основа, каркас, главное сооружение — реализуем первый блок плана.' },
        { num: '29', title: 'Фінальний проект, частина 2', desc: 'Деталі, Redstone-механіки, оформлення — доводимо проект до завершення.', title_ru: 'Финальный проект, часть 2', desc_ru: 'Детали, Redstone-механики, оформление — доводим проект до завершения.' },
      ...
      coursesDb.create({ id: 'minecraft-10-14', name: 'Minecraft + Python', name_ru: 'Minecraft + Python', emoji: '🐍', age: '10–14 років', age_group: '10-14', description: '32 заняття · mcpi API, функції, ООП, командна робота, міні-гра та фінальний проект на GitHub', description_ru: '32 занятия · mcpi API, функции, ООП, командная работа, мини-игра и финальный проект на GitHub', lessonsCount: 32, ...shared, curriculum: [
        ...
        { num: '19', title: 'NBT та теги предметів', desc: 'Кастомні enchantments і теги через API — предмети з особливими властивостями.', title_ru: 'NBT и теги предметов', desc_ru: 'Кастомные enchantments и теги через API — предметы с особыми свойствами.' },
        { num: '20', title: 'Спавн та керування мобами', desc: 'spawnEntity(), взаємодія з істотами — власні NPC та вороги кодом.', title_ru: 'Спавн и управление мобами', desc_ru: 'spawnEntity(), взаимодействие с существами — собственные NPC и враги кодом.' },
        { num: '21', title: 'Текстурні патерни через масиви', desc: 'Двовимірні масиви кольорів блоків — піксель-арт і чекборд-підлога кодом.', title_ru: 'Текстурные паттерны через массивы', desc_ru: 'Двумерные массивы цветов блоков — пиксель-арт и чекборд-пол кодом.' },
        { num: '22', title: 'Генератор лабіринтів рівня 2', desc: 'DFS-алгоритм — складніші лабіринти з гарантованим виходом щоразу.', title_ru: 'Генератор лабиринтов уровня 2', desc_ru: 'DFS-алгоритм — более сложные лабиринты с гарантированным выходом каждый раз.' },
        { num: '23', title: 'Клас World: власна обгортка', desc: 'Виносимо часто повторювані дії в один клас — код стає коротшим і чистішим.', title_ru: 'Класс World: собственная обёртка', desc_ru: 'Выносим часто повторяющиеся действия в один класс — код становится короче и чище.' },
        { num: '24', title: 'Перевірка коду перед запуском', desc: 'Прості unit-тести для функцій будівництва — ловимо помилки до того, як зламали світ.', title_ru: 'Проверка кода перед запуском', desc_ru: 'Простые unit-тесты для функций строительства — ловим ошибки до того, как сломали мир.' },
        { num: '25', title: 'Оптимізація повторних дій', desc: 'Прапорці стану, уникнення дублікатів — код не перебудовує вже готове.', title_ru: 'Оптимизация повторных действий', desc_ru: 'Флаги состояния, избежание дублей — код не перестраивает уже готовое.' },
        { num: '26', title: 'Командна робота над спільним світом', desc: 'Двоє учнів редагують один світ, узгоджують зони відповідальності через git.', title_ru: 'Командная работа над общим миром', desc_ru: 'Двое учеников редактируют один мир, согласовывают зоны ответственности через git.' },
        { num: '27', title: 'Планування фінального проекту', desc: 'Ідея, архітектура, розбивка на файли та функції — план проекту на папері і в коді.', title_ru: 'Планирование финального проекта', desc_ru: 'Идея, архитектура, разбивка на файлы и функции — план проекта на бумаге и в коде.' },
        { num: '28', title: 'Фінальний проект, частина 1', desc: 'Основна механіка, ключові функції, перший робочий прототип.', title_ru: 'Финальный проект, часть 1', desc_ru: 'Основная механика, ключевые функции, первый рабочий прототип.' },
        { num: '29', title: 'Фінальний проект, частина 2', desc: 'Деталі, баланс, ефекти, фікс багів — доводимо до презентабельного стану.', title_ru: 'Финальный проект, часть 2', desc_ru: 'Детали, баланс, эффекты, фикс багов — доводим до презентабельного состояния.' },
        { num: '30', title: 'Фінальний проект, частина 3', desc: 'Тестування, оптимізація, README на GitHub — готуємо до публічного показу.', title_ru: 'Финальный проект, часть 3', desc_ru: 'Тестирование, оптимизация, README на GitHub — готовим к публичному показу.' },
        { num: '31', title: 'Code review та рефакторинг', desc: 'Переглядаємо код одне одного, знаходимо покращення, вчимося читати чужий код.', title_ru: 'Code review и рефакторинг', desc_ru: 'Просматриваем код друг друга, находим улучшения, учимся читать чужой код.' },
...
app.get(['/', '/index.html'], (req, res, next) => {
  ...
  const m = MINECRAFT_META_RU;
  const html = MINECRAFT_INDEX_TPL
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://minecraft.mycomputer.education';
...
const ARTICLE_LABEL_MAP = {
  '🟩': {label:'Minecraft',       cls:'cat-roblox'},
  '🔴': {label:'Minecraft',       cls:'cat-roblox'},
  '⬜': {label:'Minecraft',       cls:'cat-roblox'},
  '🌾': {label:'Minecraft',       cls:'cat-roblox'},
  '🛡': {label:'Батькам',         cls:'cat-parents'},
  '🎮': {label:'Навчання',        cls:'cat-tips'},
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'minecraft.mycomputer.education',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Minecraft (лендінг)', notes: 'Заявка з minecraft.mycomputer.education' }),
      }).catch(() => {});
    }
...
// ── ARTICLE PAGES ─────────────────────────────────────────────────────────────
const ARTICLE_HTML_TPL_MC = fs.readFileSync(path.join(__dirname, '..', 'article.html'), 'utf8');
...
app.get('/articles/:slug', (req, res) => {
  ...
  <meta property="og:image" content="https://minecraft.mycomputer.education/og-image.png?v=2"/>
...
const PRIMARY_COURSE_ID = 'minecraft';
