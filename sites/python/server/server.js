    ...
    pages: [
      {
        ...
        text: 'Курс Python для дітей та підлітків 10–14 років у My Computer Academy: реальний код, ігри на Pygame, Telegram-боти. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
...
const PYTHON_META_RU = {
  ...
  desc:  'Курс Python для детей и подростков 10–14 лет онлайн. Программирование Python с нуля: переменные, функции, Pygame-игры и Telegram-бот. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'python.mycomputer.education',
    };
...
app.get('/articles/:slug', (req, res) => {
  ...
  const html = ARTICLE_HTML_TPL_PY
  ...
  <meta property="og:image" content="https://python.mycomputer.education/og-image.png?v=2"/>
