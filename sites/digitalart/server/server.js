...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (digitalart.mycomputer.school)',
        heading: 'Курс цифрового рисунка для дітей — My Computer Academy',
        text: 'Курс цифрового рисунка для дітей та підлітків 6–18 років у My Computer Academy: Photoshop, графічний планшет, власне портфоліо ілюстрацій. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо дітей від 6 років. Для молодшої групи (6–11) — прості лінії та перший персонаж, для підлітків (12–18) — повноцінна ілюстрація та концепт-арт. Конкретну групу підберемо на безкоштовній консультації.', ru:'Принимаем детей от 6 лет. Для младшей группы (6–11) — простые линии и первый персонаж, для подростков (12–18) — полноценная иллюстрация и концепт-арт. Конкретную группу подберём на бесплатной консультации.' } },
    { id:2, question:{ ua:'Чи потрібні художні навички?',       ru:'Нужны ли художественные навыки?' },          answer:{ ua:'Ні, жодного попереднього досвіду малювання не потрібно. Всі курси починаються з нуля. Потрібен тільки комп\'ютер з інтернетом і графічний планшет.', ru:'Нет, никакого предварительного опыта рисования не нужно. Все курсы начинаются с нуля. Нужен только компьютер с интернетом и графический планшет.' } },
    ...
    { id:6, question:{ ua:'Скільки тривають курси?',            ru:'Сколько длятся курсы?' },                    answer:{ ua:'Молодша група (6–11 років) навчається 15 місяців, старша (12–18) — 18 місяців при 1–2 заняттях на тиждень. Конкретна тривалість залежить від навантаження та темпу учня.', ru:'Младшая группа (6–11 лет) учится 15 месяцев, старшая (12–18) — 18 месяцев при 1–2 занятиях в неделю. Конкретная длительность зависит от нагрузки и темпа ученика.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().some(c => c.id === 'drawing-6-11')) {
      const shared = { groupSize: 5, price: 3600, color: '#C94B37', active: true };
      coursesDb.create({ id: 'drawing-6-11', name: 'Цифровий рисунок: перші кроки', name_ru: 'Цифровой рисунок: первые шаги', emoji: '✏️', age: '6–11 років', age_group: '6-11', duration: '15 місяців', description: 'Від першої лінії до власного персонажа — 22 теми · 132 заняття', description_ru: 'От первой линии до собственного персонажа — 22 темы · 132 занятия', lessonsCount: 132, ...shared, curriculum: [
      { num: '01', title: 'Знайомство з планшетом та Photoshop', desc: 'Налаштування планшета, чутливість пера, інтерфейс Photoshop для малювання.', title_ru: 'Знакомство с планшетом и Photoshop', desc_ru: 'Настройка планшета, чувствительность пера, интерфейс Photoshop для рисования.' },
      { num: '02', title: 'Впевнена лінія та прості форми', desc: 'Штрихи без тремтіння, базові геометричні фігури, перші начерки.', title_ru: 'Уверенная линия и простые формы', desc_ru: 'Штрихи без дрожи, базовые геометрические фигуры, первые наброски.' },
      { num: '03', title: 'Штрихування та текстура', desc: 'Різні пензлі Photoshop, штрихування, імітація олівця та крейди.', title_ru: 'Штриховка и текстура', desc_ru: 'Разные кисти Photoshop, штриховка, имитация карандаша и мелка.' },
      { num: '04', title: 'Композиція малюнка для дітей', desc: 'Правило третин простими словами, головний герой у кадрі, баланс аркуша.', title_ru: 'Композиция рисунка для детей', desc_ru: 'Правило третей простыми словами, главный герой в кадре, баланс листа.' },
      { num: '05', title: 'Кольорове колесо та настрій', desc: 'Теплі та холодні кольори, настрій через колір, весела і сумна палітра.', title_ru: 'Цветовое колесо и настроение', desc_ru: 'Тёплые и холодные цвета, настроение через цвет, весёлая и грустная палитра.' },
      { num: '06', title: 'Змішування кольорів у шарах', desc: 'Робота з шарами, режими накладання, заливка та градієнт.', title_ru: 'Смешивание цветов в слоях', desc_ru: 'Работа со слоями, режимы наложения, заливка и градиент.' },
      { num: '07', title: 'Від кола до кота: прості тварини', desc: 'Побудова тварин з базових форм: кіт, собака, заєць.', title_ru: 'От круга до кота: простые животные', desc_ru: 'Построение животных из базовых форм: кот, собака, заяц.' },
      { num: '08', title: 'Казкові істоти', desc: 'Власний дракон та єдиноріг із простих форм і деталей.', title_ru: 'Сказочные существа', desc_ru: 'Собственный дракон и единорог из простых форм и деталей.' },
      { num: '09', title: 'Перспектива для дітей', desc: 'Будиночок і дорога вдалину — перше відчуття простору на аркуші.', title_ru: 'Перспектива для детей', desc_ru: 'Домик и дорога вдаль — первое ощущение пространства на листе.' },
      { num: '10', title: 'Світло і тінь для початківців', desc: 'Об\'єм простих форм: куля, куб, конус — тінь та відблиск.', title_ru: 'Свет и тень для начинающих', desc_ru: 'Объём простых форм: шар, куб, конус — тень и блик.' },
      { num: '11', title: 'Осінній ліс', desc: 'Пейзаж осені: дерева, листя, тепла палітра.', title_ru: 'Осенний лес', desc_ru: 'Пейзаж осени: деревья, листья, тёплая палитра.' },
      { num: '12', title: 'Зимове місто', desc: 'Сніг, вогні, холодна палітра, проста вулична сцена.', title_ru: 'Зимний город', desc_ru: 'Снег, огни, холодная палитра, простая уличная сцена.' },
      { num: '13', title: 'Комікс у 4 кадрах', desc: 'Власна коротка історія: розкадровка та прості персонажі.', title_ru: 'Комикс в 4 кадрах', desc_ru: 'Собственная короткая история: раскадровка и простые персонажи.' },
      { num: '14', title: 'Стікери та емодзі', desc: 'Власний набір стікерів у своєму стилі — емоції персонажа.', title_ru: 'Стикеры и эмодзи', desc_ru: 'Собственный набор стикеров в своём стиле — эмоции персонажа.' },
      { num: '15', title: 'Портрет персонажа: обличчя та емоції', desc: 'Пропорції обличчя, базові емоції: радість, здивування, сум.', title_ru: 'Портрет персонажа: лицо и эмоции', desc_ru: 'Пропорции лица, базовые эмоции: радость, удивление, грусть.' },
      { num: '16', title: 'Фентезійні істоти', desc: 'Власний вихованець-фантазія: змішення рис різних тварин.', title_ru: 'Фентезийные существа', desc_ru: 'Собственный питомец-фантазия: смешение черт разных животных.' },
      { num: '17', title: 'Природа: квіти та дерева', desc: 'Рослинні форми, текстура листя, простий ботанічний малюнок.', title_ru: 'Природа: цветы и деревья', desc_ru: 'Растительные формы, текстура листвы, простой ботанический рисунок.' },
      { num: '18', title: 'Транспорт у мультяшному стилі', desc: 'Машинки, кораблики, ракети — спрощені форми техніки.', title_ru: 'Транспорт в мультяшном стиле', desc_ru: 'Машинки, кораблики, ракеты — упрощённые формы техники.' },
      { num: '19', title: 'Костюм персонажа', desc: 'Одяг та аксесуари, які розповідають про героя.', title_ru: 'Костюм персонажа', desc_ru: 'Одежда и аксессуары, которые рассказывают о герое.' },
      { num: '20', title: 'Персонаж у русі', desc: 'Проста динамічна поза: біг, стрибок, політ.', title_ru: 'Персонаж в движении', desc_ru: 'Простая динамичная поза: бег, прыжок, полёт.' },
      { num: '21', title: 'Фон для персонажа', desc: 'Просте оточення: кімната, ліс, космос — герой у своєму світі.', title_ru: 'Фон для персонажа', desc_ru: 'Простое окружение: комната, лес, космос — герой в своём мире.' },
      { num: '🚀', title: 'Фінал: власна ілюстрація персонажа', desc: 'Завершена кольорова ілюстрація з фоном — перша робота в портфоліо.', title_ru: 'Финал: собственная иллюстрация персонажа', desc_ru: 'Завершённая цветная иллюстрация с фоном — первая работа в портфолио.' },
      ]});
      coursesDb.create({ id: 'drawing-12-18', name: 'Цифровий рисунок та ілюстрація: від ескізу до портфоліо', name_ru: 'Цифровой рисунок и иллюстрация: от эскиза до портфолио', emoji: '🎨', age: '12–18 років', age_group: '12-18', duration: '18 місяців', description: 'Photoshop, концепт-арт та дизайн персонажів — 26 тем · 150 занять', description_ru: 'Photoshop, концепт-арт и дизайн персонажей — 26 тем · 150 занятий', lessonsCount: 150, ...shared, curriculum: [
      { num: '01', title: 'Робочий процес художника', desc: 'Від референсу до фінальної роботи: етапи професійної ілюстрації.', title_ru: 'Рабочий процесс художника', desc_ru: 'От референса до финальной работы: этапы профессиональной иллюстрации.' },
      { num: '02', title: 'Photoshop для ілюстратора', desc: 'Шари, режими накладання, маски, гарячі клавіші — робочий інтерфейс художника.', title_ru: 'Photoshop для иллюстратора', desc_ru: 'Слои, режимы наложения, маски, горячие клавиши — рабочий интерфейс художника.' },
      { num: '03', title: 'Кастомні пензлі та текстури', desc: 'Налаштування та створення власних пензлів, текстурні пресети.', title_ru: 'Кастомные кисти и текстуры', desc_ru: 'Настройка и создание собственных кистей, текстурные пресеты.' },
      { num: '04', title: 'Академічний рисунок цифровим інструментом', desc: 'Впевнена лінія, форма, конструктивний підхід до рисунка.', title_ru: 'Академический рисунок цифровым инструментом', desc_ru: 'Уверенная линия, форма, конструктивный подход к рисунку.' },
      { num: '05', title: 'Перспектива: одно-, дво- та триточкова', desc: 'Побудова простору та об\'єктів у перспективі для ілюстрації.', title_ru: 'Перспектива: одно-, двух- и трёхточечная', desc_ru: 'Построение пространства и объектов в перспективе для иллюстрации.' },
      { num: '06', title: 'Анатомія людини: пропорції фігури', desc: 'Скелет пропорцій, базові пози, жіноча та чоловіча фігура.', title_ru: 'Анатомия человека: пропорции фигуры', desc_ru: 'Скелет пропорций, базовые позы, женская и мужская фигура.' },
      { num: '07', title: 'Анатомія обличчя та емоції', desc: 'Побудова голови, пропорції обличчя, палітра емоцій персонажа.', title_ru: 'Анатомия лица и эмоции', desc_ru: 'Построение головы, пропорции лица, палитра эмоций персонажа.' },
      { num: '08', title: 'Жести та динамічні пози', desc: 'Швидкі жестові начерки, лінія дії, відчуття руху.', title_ru: 'Жесты и динамичные позы', desc_ru: 'Быстрые жестовые наброски, линия действия, ощущение движения.' },
      { num: '09', title: 'Теорія кольору для ілюстратора', desc: 'Кольорові схеми, колористика настрою, обмежена палітра.', title_ru: 'Теория цвета для иллюстратора', desc_ru: 'Цветовые схемы, колористика настроения, ограниченная палитра.' },
      { num: '10', title: 'Світло і тінь: об\'єм складних форм', desc: 'Джерела світла, рефлекси, півтони на складних об\'єктах і фігурі.', title_ru: 'Свет и тень: объём сложных форм', desc_ru: 'Источники света, рефлексы, полутона на сложных объектах и фигуре.' },
      { num: '11', title: 'Композиція кадру', desc: 'Фокус уваги, баланс, ритм та напрямні лінії в ілюстрації.', title_ru: 'Композиция кадра', desc_ru: 'Фокус внимания, баланс, ритм и направляющие линии в иллюстрации.' },
      { num: '12', title: 'Дизайн персонажа: від ескізу до образу', desc: 'Розробка силуету, рис характеру через зовнішність, варіації дизайну.', title_ru: 'Дизайн персонажа: от эскиза к образу', desc_ru: 'Разработка силуэта, черт характера через внешность, вариации дизайна.' },
      { num: '13', title: 'Костюм та аксесуари персонажа', desc: 'Опрацювання одягу, матеріалів та деталей образу.', title_ru: 'Костюм и аксессуары персонажа', desc_ru: 'Проработка одежды, материалов и деталей образа.' },
      { num: '14', title: 'Стилізація та власний стиль', desc: 'Пошук індивідуальної художньої манери, спрощення форм.', title_ru: 'Стилизация и собственный стиль', desc_ru: 'Поиск индивидуальной художественной манеры, упрощение форм.' },
      { num: '15', title: 'Концепт-арт середовища', desc: 'Пейзаж та локація як частина історії персонажа.', title_ru: 'Концепт-арт окружения', desc_ru: 'Пейзаж и локация как часть истории персонажа.' },
      { num: '16', title: 'Концепт-арт інтер\'єру', desc: 'Простір та предмети інтер\'єру в єдиному стилі сцени.', title_ru: 'Концепт-арт интерьера', desc_ru: 'Пространство и предметы интерьера в едином стиле сцены.' },
      { num: '17', title: 'Робота з референсами', desc: 'Збір референсів, фотобаш, компонування декількох джерел.', title_ru: 'Работа с референсами', desc_ru: 'Сбор референсов, фотобаши, компоновка нескольких источников.' },
      { num: '18', title: 'Спецефекти: вогонь, вода, магія', desc: 'Пензлі та прийоми для стихійних і магічних ефектів.', title_ru: 'Спецэффекты: огонь, вода, магия', desc_ru: 'Кисти и приёмы для стихийных и магических эффектов.' },
      { num: '19', title: 'Ілюстрація для книги', desc: 'Розворот книги: композиція під текст, єдиний візуальний стиль серії.', title_ru: 'Иллюстрация для книги', desc_ru: 'Разворот книги: композиция под текст, единый визуальный стиль серии.' },
      { num: '20', title: 'Обкладинка та постер', desc: 'Композиція для друку, типографіка на ілюстрації, формат під тираж.', title_ru: 'Обложка и постер', desc_ru: 'Композиция для печати, типографика на иллюстрации, формат под тираж.' },
      { num: '21', title: 'Розкадровка коміксу', desc: 'Розповідь через серію кадрів, ритм оповіді, мовні бульбашки.', title_ru: 'Раскадровка комикса', desc_ru: 'Рассказ через серию кадров, ритм повествования, речевые пузыри.' },
      { num: '22', title: 'Стилізований портрет', desc: 'Портретна ілюстрація в обраному художньому стилі.', title_ru: 'Стилизованный портрет', desc_ru: 'Портретная иллюстрация в выбранном художественном стиле.' },
      { num: '23', title: 'Fan-art: улюблений персонаж', desc: 'Власна інтерпретація персонажа з гри, фільму чи книги.', title_ru: 'Fan-art: любимый персонаж', desc_ru: 'Собственная интерпретация персонажа из игры, фильма или книги.' },
      { num: '24', title: 'Скетчі та speed painting', desc: 'Швидка щоденна практика, начерки за 15–30 хвилин.', title_ru: 'Скетчи и speed painting', desc_ru: 'Быстрая ежедневная практика, наброски за 15–30 минут.' },
      { num: '25', title: 'Формування портфоліо художника', desc: 'Відбір найкращих робіт, оформлення подачі, презентація проєктів.', title_ru: 'Формирование портфолио художника', desc_ru: 'Отбор лучших работ, оформление подачи, презентация проектов.' },
      { num: '26', title: 'Основи фрілансу для художника', desc: 'Як показати роботи замовнику, перші замовлення, майданчики для художників.', title_ru: 'Основы фриланса для художника', desc_ru: 'Как показать работы заказчику, первые заказы, площадки для художников.' },
      { num: '🚀', title: 'Дипломна робота', desc: 'Серія ілюстрацій у власному стилі — фінальний проєкт портфоліо.', title_ru: 'Дипломная работа', desc_ru: 'Серия иллюстраций в собственном стиле — финальный проект портфолио.' },
      ]});
      console.log('✅  Seeded digitalart age-group courses (6-11, 12-18)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Марія Гончар',    'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'Цифровий рисунок, ілюстрація' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'Цифровий рисунок для дітей' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age:  9, course: 'drawing-6-11',  phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 14, course: 'drawing-12-18', phone: '+380502002002', status: 'active', teacher: 'Марія Гончар',   lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 16, course: 'drawing-12-18', phone: '+380503003003', status: 'active', teacher: 'Марія Гончар',   lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age:  7, course: 'drawing-6-11',  phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age:  8, course: 'drawing-6-11',  phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 15, course: 'drawing-12-18', phone: '+380506006006', status: 'active', teacher: 'Марія Гончар',   lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const PYTHON_META_RU = {
  title: 'Курс цифрового рисунка для детей — My Computer Academy',
  desc:  'Курс цифрового рисунка для детей и подростков 6–18 лет онлайн. Photoshop и графический планшет: от первых линий до собственной иллюстрации. Первый урок бесплатно.',
};
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://digitalart.mycomputer.school';
...
const ARTICLE_LABEL_MAP = {
  '✏️': {label:'Цифровий рисунок',  cls:'cat-design'},
  '🎨': {label:'Ілюстрація',        cls:'cat-design'},
  '🖌️': {label:'Photoshop',        cls:'cat-design'},
  '🧑‍🎤': {label:'Персонажі',      cls:'cat-design'},
...
app.get('/articles', (req, res) => {
  ...
  const siteUrl = 'https://digitalart.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'digitalart.mycomputer.school',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Цифровий рисунок (лендинг)', notes: 'Заявка з digitalart.mycomputer.school' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  let html = ARTICLE_HTML_TPL_PY
    ...
    .replace('<meta name="description" id="pageDesc" content="Корисні статті про цифровий рисунок для дітей від My Computer Academy"/>',
             `<meta name="description" id="pageDesc" content="${escHtml(excerpt) || 'Корисні статті про цифровий рисунок для дітей від My Computer Academy'}"/>
  ...
  <meta property="og:image" content="https://digitalart.mycomputer.school/og-image.png?v=2"/>
...
const COURSE_SLUGS = ['drawing-6-11', 'drawing-12-18'];
...
app.get('/courses/:slug', (req, res) => {
  ...
  const rawDesc = (isRu && course.description_ru) ? course.description_ru : (course.description || 'Детальна інформація про курс цифрового рисунка для дітей у My Computer Academy');
  ...
  let html = COURSE_HTML_TPL
    ...
    .replace(
      '<meta name="description" content="Детальна інформація про курс цифрового рисунка для дітей у My Computer Academy"/>',
