...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().some(c => c.id === 'drawing-6-11')) {
      ...
      coursesDb.create({ id: 'drawing-6-11', name: 'Цифровий рисунок: перші кроки', emoji: '✏️', age: '6–11 років', age_group: '6-11', duration: '15 місяців', description: 'Від першої лінії до власного персонажа — 22 теми · 132 заняття', lessonsCount: 132, ...shared, curriculum: [
        { num: '01', title: 'Знайомство з планшетом та Photoshop', desc: 'Налаштування планшета, чутливість пера, інтерфейс Photoshop для малювання.' },
        { num: '02', title: 'Впевнена лінія та прості форми', desc: 'Штрихи без тремтіння, базові геометричні фігури, перші начерки.' },
        { num: '03', title: 'Штрихування та текстура', desc: 'Різні пензлі Photoshop, штрихування, імітація олівця та крейди.' },
        { num: '04', title: 'Композиція малюнка для дітей', desc: 'Правило третин простими словами, головний герой у кадрі, баланс аркуша.' },
        { num: '05', title: 'Кольорове колесо та настрій', desc: 'Теплі та холодні кольори, настрій через колір, весела і сумна палітра.' },
        { num: '06', title: 'Змішування кольорів у шарах', desc: 'Робота з шарами, режими накладання, заливка та градієнт.' },
        { num: '07', title: 'Від кола до кота: прості тварини', desc: 'Побудова тварин з базових форм: кіт, собака, заєць.' },
        { num: '08', title: 'Казкові істоти', desc: 'Власний дракон та єдиноріг із простих форм і деталей.' },
        { num: '09', title: 'Перспектива для дітей', desc: 'Будиночок і дорога вдалину — перше відчуття простору на аркуші.' },
        { num: '10', title: 'Світло і тінь для початківців', desc: 'Об\'єм простих форм: куля, куб, конус — тінь та відблиск.' },
        { num: '11', title: 'Осінній ліс', desc: 'Пейзаж осені: дерева, листя, тепла палітра.' },
        { num: '12', title: 'Зимове місто', desc: 'Сніг, вогні, холодна палітра, проста вулична сцена.' },
        { num: '13', title: 'Комікс у 4 кадрах', desc: 'Власна коротка історія: розкадровка та прості персонажі.' },
        { num: '14', title: 'Стікери та емодзі', desc: 'Власний набір стікерів у своєму стилі — емоції персонажа.' },
        { num: '15', title: 'Портрет персонажа: обличчя та емоції', desc: 'Пропорції обличчя, базові емоції: радість, здивування, сум.' },
        { num: '16', title: 'Фентезійні істоти', desc: 'Власний вихованець-фантазія: змішення рис різних тварин.' },
        { num: '17', title: 'Природа: квіти та дерева', desc: 'Рослинні форми, текстура листя, простий ботанічний малюнок.' },
        { num: '18', title: 'Транспорт у мультяшному стилі', desc: 'Машинки, кораблики, ракети — спрощені форми техніки.' },
        { num: '19', title: 'Костюм персонажа', desc: 'Одяг та аксесуари, які розповідають про героя.' },
        { num: '20', title: 'Персонаж у русі', desc: 'Проста динамічна поза: біг, стрибок, політ.' },
        { num: '21', title: 'Фон для персонажа', desc: 'Просте оточення: кімната, ліс, космос — герой у своєму світі.' },
        { num: '🚀', title: 'Власна ілюстрація персонажа', desc: 'Завершена кольорова ілюстрація з фоном — перша робота в портфоліо.' },
      ]});
      coursesDb.create({ id: 'drawing-12-18', name: 'Цифровий рисунок та ілюстрація: від ескізу до портфоліо', emoji: '🎨', age: '12–18 років', age_group: '12-18', duration: '18 місяців', description: 'Photoshop, концепт-арт та дизайн персонажів — 26 тем · 150 занять', lessonsCount: 150, ...shared, curriculum: [
        { num: '01', title: 'Робочий процес художника', desc: 'Від референсу до фінальної роботи: етапи професійної ілюстрації.' },
        { num: '02', title: 'Photoshop для ілюстратора', desc: 'Шари, режими накладання, маски, гарячі клавіші — робочий інтерфейс художника.' },
        { num: '03', title: 'Кастомні пензлі та текстури', desc: 'Налаштування та створення власних пензлів, текстурні пресети.' },
        { num: '04', title: 'Академічний рисунок цифровим інструментом', desc: 'Впевнена лінія, форма, конструктивний підхід до рисунка.' },
        { num: '05', title: 'Перспектива: одно-, дво- та триточкова', desc: 'Побудова простору та об\'єктів у перспективі для ілюстрації.' },
        { num: '06', title: 'Анатомія людини: пропорції фігури', desc: 'Скелет пропорцій, базові пози, жіноча та чоловіча фігура.' },
        { num: '07', title: 'Анатомія обличчя та емоції', desc: 'Побудова голови, пропорції обличчя, палітра емоцій персонажа.' },
        { num: '08', title: 'Жести та динамічні пози', desc: 'Швидкі жестові начерки, лінія дії, відчуття руху.' },
        { num: '09', title: 'Теорія кольору для ілюстратора', desc: 'Кольорові схеми, колористика настрою, обмежена палітра.' },
        { num: '10', title: 'Світло і тінь: об\'єм складних форм', desc: 'Джерела світла, рефлекси, півтони на складних об\'єктах і фігурі.' },
        { num: '11', title: 'Композиція кадру', desc: 'Фокус уваги, баланс, ритм та напрямні лінії в ілюстрації.' },
        { num: '12', title: 'Дизайн персонажа: від ескізу до образу', desc: 'Розробка силуету, рис характеру через зовнішність, варіації дизайну.' },
        { num: '13', title: 'Костюм та аксесуари персонажа', desc: 'Опрацювання одягу, матеріалів та деталей образу.' },
        { num: '14', title: 'Стилізація та власний стиль', desc: 'Пошук індивідуальної художньої манери, спрощення форм.' },
        { num: '15', title: 'Концепт-арт середовища', desc: 'Пейзаж та локація як частина історії персонажа.' },
        { num: '16', title: 'Концепт-арт інтер\'єру', desc: 'Простір та предмети інтер\'єру в єдиному стилі сцени.' },
        { num: '17', title: 'Робота з референсами', desc: 'Збір референсів, фотобаш, компонування декількох джерел.' },
        { num: '18', title: 'Спецефекти: вогонь, вода, магія', desc: 'Пензлі та прийоми для стихійних і магічних ефектів.' },
        { num: '19', title: 'Ілюстрація для книги', desc: 'Розворот книги: композиція під текст, єдиний візуальний стиль серії.' },
        { num: '20', title: 'Обкладинка та постер', desc: 'Композиція для друку, типографіка на ілюстрації, формат під тираж.' },
        { num: '21', title: 'Розкадровка коміксу', desc: 'Розповідь через серію кадрів, ритм оповіді, мовні бульбашки.' },
        { num: '22', title: 'Стилізований портрет', desc: 'Портретна ілюстрація в обраному художньому стилі.' },
        { num: '23', title: 'Fan-art: улюблений персонаж', desc: 'Власна інтерпретація персонажа з гри, фільму чи книги.' },
        { num: '24', title: 'Скетчі та speed painting', desc: 'Швидка щоденна практика, начерки за 15–30 хвилин.' },
        { num: '25', title: 'Формування портфоліо художника', desc: 'Відбір найкращих робіт, оформлення подачі, презентація проєктів.' },
        { num: '26', title: 'Основи фрілансу для художника', desc: 'Як показати роботи замовнику, перші замовлення, майданчики для художників.' },
        { num: '🚀', title: 'Дипломна робота', desc: 'Серія ілюстрацій у власному стилі — фінальний проєкт портфоліо.' },
      ]});
