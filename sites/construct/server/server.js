...
const CONTENT_SEED = {
  pricing: [
    {
      ...
      features: [
        { ua: '12 місяців, один раз на тиждень, 90 хв', ru: '12 месяцев, один раз в неделю, 90 мин' },
    ...
    },
    {
      ...
      features: [
        { ua: '12 місяців, два рази на тиждень, по 90 хв', ru: '12 месяцев, два раза в неделю, по 90 минут' },
        { ua: 'Мала група до 5 дітей',                       ru: 'Малая группа до 5 детей' },
        { ua: 'Доступ до матеріалів назавжди',               ru: 'Доступ к материалам навсегда' },
      ],
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (construct.mycomputer.education)',
        heading: 'Курс Construct 3 для дітей — My Computer Academy',
        text: 'Курс розробки ігор у Construct 3 для дітей та підлітків 10–14 років у My Computer Academy: платформери, стрілялки, аркади без єдиного рядка коду. Малі групи до 6 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо дітей від 10 років — вік, коли вже комфортно розбиратись у подійній логіці Construct 3. Конкретний рівень підберемо на безкоштовній консультації.', ru:'Принимаем детей от 10 лет — возраст, когда уже комфортно разбираться в событийной логике Construct 3. Конкретный уровень подберём на бесплатной консультации.' } },
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс Construct 3 триває 12 місяців при 1–2 заняттях на тиждень — 30 тем від подій та логіки до публікації й монетизації готової гри.', ru:'Полный курс Construct 3 длится 12 месяцев при 1–2 занятиях в неделю — 30 тем от событий и логики до публикации и монетизации готовой игры.' } },
  ...
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        ...
        {"num":"Тема 3","title":"Робота зі спрайтами","desc":"Імпорт та налаштування спрайтів, анімація (цикли та тригери), позиції об'єктів, інтерактивні об'єкти.","title_ru":"Работа со спрайтами","desc_ru":"Импорт и настройка спрайтов, анимация (циклы и триггеры), позиции объектов, интерактивные объекты."},
        {"num":"Тема 4","title":"Події та логіка","desc":"Подійна система Construct 3, умови та дії, глобальні та локальні змінні, функції для спрощення логіки.","title_ru":"События и логика","desc_ru":"Событийная система Construct 3, условия и действия, глобальные и локальные переменные, функции для упрощения логики."},
        {"num":"Тема 5","title":"Фізика та взаємодія об'єктів","desc":"Фізична поведінка об'єктів, колізії та тригери, реалістична фізика, швидкість, маса та гравітація.","title_ru":"Физика и взаимодействие объектов","desc_ru":"Физическое поведение объектов, коллизии и триггеры, реалистичная физика, скорость, масса и гравитация."},
        {"num":"Тема 6","title":"Ігрові механіки","desc":"Рух персонажа (платформери), стрільба, стрибки, взаємодії, таймери, система здоров'я та життів.","title_ru":"Игровые механики","desc_ru":"Движение персонажа (платформеры), стрельба, прыжки, взаимодействия, таймеры, система здоровья и жизней."},
        {"num":"Тема 7","title":"Інтерфейс (UI/UX)","desc":"Екрани меню та налаштувань, кнопки, шкали, індикатори, HUD, анімація інтерфейсу.","title_ru":"Интерфейс (UI/UX)","desc_ru":"Экраны меню и настроек, кнопки, шкалы, индикаторы, HUD, анимация интерфейса."},
        {"num":"Тема 8","title":"Робота з рівнями","desc":"Багатосценічні проєкти, тайловий дизайн рівнів, портали та переходи між сценами, генерація рівнів.","title_ru":"Работа с уровнями","desc_ru":"Многосценные проекты, тайловый дизайн уровней, порталы и переходы между сценами, генерация уровней."},
        {"num":"Тема 9","title":"Аудіо та звуки","desc":"Імпорт звукових файлів, фонова музика, управління гучністю та ефектами, звуки для подій.","title_ru":"Аудио и звуки","desc_ru":"Импорт звуковых файлов, фоновая музыка, управление громкостью и эффектами, звуки для событий."},
        {"num":"Тема 10","title":"Збереження прогресу","desc":"Локальне сховище, збереження/завантаження прогресу, таблиці лідерів, система чекпоінтів.","title_ru":"Сохранение прогресса","desc_ru":"Локальное хранилище, сохранение/загрузка прогресса, таблицы лидеров, система чекпоинтов."},
        {"num":"Тема 11","title":"Оптимізація продуктивності","desc":"Оптимізація пам'яті, рендеринг та текстури, зниження навантаження на процесор, налагодження та тестування.","title_ru":"Оптимизация производительности","desc_ru":"Оптимизация памяти, рендеринг и текстуры, снижение нагрузки на процессор, отладка и тестирование."},
        {"num":"Тема 12","title":"Публікація проєкту","desc":"Експорт для вебу, Windows та мобільних, Google Play та App Store, Construct Arcade.","title_ru":"Публикация проекта","desc_ru":"Экспорт для веба, Windows и мобильных, Google Play и App Store, Construct Arcade."},
        {"num":"Тема 13","title":"Монетизація ігор","desc":"Реклама в іграх, внутрішньоігрові покупки, преміум-контент, публікація безкоштовних і платних ігор.","title_ru":"Монетизация игр","desc_ru":"Реклама в играх, внутриигровые покупки, премиум-контент, публикация бесплатных и платных игр."},
        {"num":"Тема 14","title":"Колективна розробка","desc":"Командна робота, спільні сховища, управління версіями проєкту, підготовка документації.","title_ru":"Коллективная разработка","desc_ru":"Командная работа, общие хранилища, управление версиями проекта, подготовка документации."},
        {"num":"Тема 15","title":"Практичні проєкти","desc":"Міні-ігри (аркади, пазли, платформери), робота від ідеї до завершення, конкурси, демонстрація робіт.","title_ru":"Практические проекты","desc_ru":"Мини-игры (аркады, пазлы, платформеры), работа от идеи до завершения, конкурсы, демонстрация работ."},
        {"num":"Тема 16","title":"Процедурна генерація","desc":"Випадково генеровані рівні, алгоритми генерації об'єктів, шуми Перліна для карт, вороги та предмети.","title_ru":"Процедурная генерация","desc_ru":"Случайно генерируемые уровни, алгоритмы генерации объектов, шумы Перлина для карт, враги и предметы."},
        {"num":"Тема 17","title":"ШІ для персонажів","desc":"Поведінка ворогів, стани ШІ (патрулювання, атака, відпочинок), Pathfinding, адаптивна поведінка.","title_ru":"ИИ для персонажей","desc_ru":"Поведение врагов, состояния ИИ (патрулирование, атака, отдых), Pathfinding, адаптивное поведение."},
        {"num":"Тема 18","title":"Багатокористувацькі ігри","desc":"Мережеві можливості Construct 3, локальний мультиплеєр, WebSocket для онлайн-ігор, синхронізація гравців.","title_ru":"Многопользовательские игры","desc_ru":"Сетевые возможности Construct 3, локальный мультиплеер, WebSocket для онлайн-игр, синхронизация игроков."},
        {"num":"Тема 19","title":"Спрайти та ефекти (просунуто)","desc":"Анімація спрайтів, погодні ефекти (дощ, сніг), паралакс-шари.","title_ru":"Спрайты и эффекты (продвинутый уровень)","desc_ru":"Анимация спрайтов, погодные эффекты (дождь, снег), параллакс-слои."},
        {"num":"Тема 20","title":"Просунуті анімації","desc":"Анімація з кістками, часова шкала синхронізації, анімація за подіями, зовнішні анімаційні файли.","title_ru":"Продвинутые анимации","desc_ru":"Анимация с костями, временная шкала синхронизации, анимация по событиям, внешние анимационные файлы."},
        {"num":"Тема 21","title":"RPG-системи","desc":"Інвентар та предмети, система навичок і рівнів, діалогові вікна, бойова система.","title_ru":"RPG-системы","desc_ru":"Инвентарь и предметы, система навыков и уровней, диалоговые окна, боевая система."},
        {"num":"Тема 22","title":"Ігрові сценарії","desc":"Нелінійний сюжет, вибір гравця та наслідки, кілька кінцівок, тригери для катсцен.","title_ru":"Игровые сценарии","desc_ru":"Нелинейный сюжет, выбор игрока и последствия, несколько концовок, триггеры для катсцен."},
        {"num":"Тема 23","title":"Пазли та головоломки","desc":"Логічні задачі, системи взаємодії об'єктів, ланцюги реакцій (доміно), час як елемент складності.","title_ru":"Пазлы и головоломки","desc_ru":"Логические задачи, системы взаимодействия объектов, цепочки реакций (домино), время как элемент сложности."},
        {"num":"Тема 24","title":"Аркадні ігри","desc":"Ліміти часу та очок, рівні з наростаючою складністю, бонуси та нагороди, безкінечні ігрові цикли.","title_ru":"Аркадные игры","desc_ru":"Лимиты времени и очков, уровни с нарастающей сложностью, бонусы и награды, бесконечные игровые циклы."},
        {"num":"Тема 25","title":"Розширення та плагіни","desc":"Офіційні та сторонні плагіни, аналітика, соціальні функції, унікальні механіки через бібліотеки.","title_ru":"Расширения и плагины","desc_ru":"Официальные и сторонние плагины, аналитика, социальные функции, уникальные механики через библиотеки."},
        {"num":"Тема 26","title":"Тестування та налагодження","desc":"Виявлення та усунення багів, етапи тестування (альфа, бета), робота з відгуками гравців.","title_ru":"Тестирование и отладка","desc_ru":"Выявление и устранение багов, этапы тестирования (альфа, бета), работа с отзывами игроков."},
        {"num":"Тема 27","title":"Гейм-дизайн рівнів","desc":"Динаміка рівнів, баланс складності, секретні зони та бонуси, налаштування прогресії.","title_ru":"Гейм-дизайн уровней","desc_ru":"Динамика уровней, баланс сложности, секретные зоны и бонусы, настройка прогрессии."},
        {"num":"Тема 28","title":"Міні-ігри","desc":"Вбудовування міні-ігор, навчання механікам через міні-ігри, клікери, таймери, змагальні міні-ігри.","title_ru":"Мини-игры","desc_ru":"Встраивание мини-игр, обучение механикам через мини-игры, кликеры, таймеры, соревновательные мини-игры."},
        {"num":"Тема 29","title":"Кастомізація гравця","desc":"Налаштування персонажа (одяг, колір), переназначення клавіш, система скінів та аватарів, кастомні рівні.","title_ru":"Кастомизация игрока","desc_ru":"Настройка персонажа (одежда, цвет), переназначение клавиш, система скинов и аватаров, кастомные уровни."},
        {"num":"Тема 30","title":"Підготовка до запуску гри","desc":"Промо-матеріали (трейлери, скріншоти), Steam та Google Play, політика конфіденційності, маркетинг.","title_ru":"Подготовка к запуску игры","desc_ru":"Промо-материалы (трейлеры, скриншоты), Steam и Google Play, политика конфиденциальности, маркетинг."}
        ],
      });
      console.log('✅  Seeded construct course (30 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'Construct 3, гейм-дизайн' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'Construct 3 для молодшої групи' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 11, course: 'construct', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 12, course: 'construct', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 13, course: 'construct', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 10, course: 'construct', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age: 14, course: 'construct', phone: '+380505005005', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 12, course: 'construct', phone: '+380506006006', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const CONSTRUCT_INDEX_TPL = fs.readFileSync(path.join(__dirname, '..', 'index.html'), 'utf8');
const CONSTRUCT_META_RU = {
  title: 'Курс Construct 3 для детей и подростков — My Computer Academy, разработка игр без кода',
  desc:  'Курс разработки игр в Construct 3 для детей и подростков 10–14 лет онлайн. Платформеры, стрелялки, аркады без единой строчки кода. Малые группы до 6 человек. Первый урок бесплатно.',
};
app.get(['/', '/index.html'], (req, res, next) => {
  if (req.query.lang !== 'ru') return next();
  const m = CONSTRUCT_META_RU;
  const html = CONSTRUCT_INDEX_TPL
...
const ARTICLE_LABEL_MAP = {
  '🕹️': {label:'Construct 3',       cls:'cat-python'},
  '🚀': {label:'Construct 3',       cls:'cat-python'},
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'construct.mycomputer.education',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Construct (лендинг)', notes: 'Заявка з construct.mycomputer.education' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  <meta property="og:image" content="https://construct.mycomputer.education/og-image.png?v=2"/>
...
const PRIMARY_COURSE_ID = 'construct';
