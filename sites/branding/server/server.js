...
const CONTENT_SEED = {
  ...
  seo: {
    pages: [
      {
        id: 'main',
        label: 'Головна сторінка (branding.mycomputer.school)',
        heading: 'Курс брендингу та логотипів для підлітків — My Computer Academy',
        text: 'Курс розробки фірмового стилю для підлітків 12–18 років у My Computer Academy: логотип, кольори, шрифти, власний брендбук. Малі групи до 5 осіб, перший урок безкоштовно.',
      },
    ],
  },
  faq: [
    { id:1, question:{ ua:'З якого віку можна починати?',       ru:'С какого возраста можно начинать?' },       answer:{ ua:'Приймаємо підлітків від 12 років — вік, коли вже комфортно освоювати теорію prompt engineering та критично оцінювати AI-результат.', ru:'Принимаем подростков от 12 лет — возраст, когда уже комфортно осваивать теорию prompt engineering и критически оценивать AI-результат.' } },
    ...
    { id:6, question:{ ua:'Скільки триває курс?',                ru:'Сколько длится курс?' },                     answer:{ ua:'Повний курс брендингу триває 9 місяців при 1–2 заняттях на тиждень — 8 тем від основ брендингу до власного брендбуку в портфоліо.', ru:'Полный курс брендинга длится 9 месяцев при 1–2 занятиях в неделю — 8 тем от основ брендинга до собственного брендбука в портфолио.' } },
...
(function seedTestData() {
  try {
    if (!coursesDb.getAll().length) {
      coursesDb.create({
        id: 'branding', name: "Брендинг та логотипи", name_ru: "Брендинг и логотипы", emoji: "🏷️",
        age: "12–18 років", age_group: "14-18",
        ...
        description_ru: "Разработка фирменного стиля в Illustrator: от идеи логотипа до полного брендбука.",
        curriculum: [
        {"num":"Тема 1","title":"Основи брендингу","desc":"Що таке бренд, brand identity, аналіз успішних брендів.","title_ru":"Основы брендинга","desc_ru":"Что такое бренд, brand identity, анализ успешных брендов."},
        {"num":"Тема 2","title":"Дослідження та концепція","desc":"Аналіз ніші та конкурентів, мудборд, формування ідеї логотипу.","title_ru":"Исследование и концепция","desc_ru":"Анализ ниши и конкурентов, мудборд, формирование идеи логотипа."},
        {"num":"Тема 3","title":"Ескізування логотипу","desc":"Пошук форми на папері, варіанти композиції, вибір напрямку.","title_ru":"Эскизирование логотипа","desc_ru":"Поиск формы на бумаге, варианты композиции, выбор направления."},
        {"num":"Тема 4","title":"Векторизація в Illustrator","desc":"Перенесення ескізу у вектор, робота з кривими Безьє.","title_ru":"Векторизация в Illustrator","desc_ru":"Перенос эскиза в вектор, работа с кривыми Безье."},
        {"num":"Тема 5","title":"Типографіка бренду","desc":"Вибір шрифтів, логотип-надпис, поєднання знаку і тексту.","title_ru":"Типографика бренда","desc_ru":"Выбор шрифтов, логотип-надпись, сочетание знака и текста."},
        {"num":"Тема 6","title":"Кольорова палітра бренду","desc":"Підбір фірмових кольорів, психологія кольору в брендингу.","title_ru":"Цветовая палитра бренда","desc_ru":"Подбор фирменных цветов, психология цвета в брендинге."},
        {"num":"Тема 7","title":"Варіативність логотипу","desc":"Горизонтальна/вертикальна версії, чорно-біла версія, іконка/фавікон.","title_ru":"Вариативность логотипа","desc_ru":"Горизонтальная/вертикальная версии, чёрно-белая версия, иконка/фавикон."},
        {"num":"Тема 8","title":"Носії фірмового стилю","desc":"Візитка, бланк, упаковка — застосування логотипу на реальних матеріалах.","title_ru":"Носители фирменного стиля","desc_ru":"Визитка, бланк, упаковка — применение логотипа на реальных материалах."},
        {"num":"Фінал","title":"Власний брендбук","desc":"Повний гайдлайн бренду: логотип, кольори, шрифти, приклади застосування.","title_ru":"Собственный брендбук","desc_ru":"Полный гайдлайн бренда: логотип, цвета, шрифты, примеры применения."}
        ],
      });
      console.log('✅  Seeded branding course (9 modules)');
    }
    ...
    if (!adminsDb.getAll().some(a => a.role === 'teacher')) {
      adminsDb.create('Богдан Коваль',   'teacher', { hourlyRate: 150, lessonDuration: 60, phone: '+380501234567', notes: 'Брендинг, логотипи' });
      adminsDb.create('Аліна Петренко',  'teacher', { hourlyRate: 130, lessonDuration: 60, phone: '+380671234568', notes: 'Брендинг, Illustrator' });
      console.log('✅  Seeded 2 test teachers');
    }
    if (!clientsDb.getAll().some(c => c.scheduleDays && c.scheduleDays.length > 0)) {
      [
        { name: 'Марко Тищенко',    age: 14, course: 'branding', phone: '+380501001001', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'1',time:'15:00'},{day:'4',time:'15:00'}], schedule: 'Пн 15:00, Чт 15:00' },
        { name: 'Діана Коваль',     age: 15, course: 'branding', phone: '+380502002002', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'16:00'},{day:'5',time:'16:00'}], schedule: 'Вт 16:00, Пт 16:00' },
        { name: 'Артем Мороз',      age: 17, course: 'branding', phone: '+380503003003', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'individual', scheduleDays: [{day:'3',time:'17:00'}],                       schedule: 'Ср 17:00' },
        { name: 'Соня Петрик',      age: 13, course: 'branding', phone: '+380504004004', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'3',time:'14:30'}],                       schedule: 'Ср 14:30' },
        { name: 'Данило Романів',   age: 12, course: 'branding', phone: '+380505005005', status: 'active', teacher: 'Аліна Петренко', lessonType: 'group',      scheduleDays: [{day:'6',time:'10:00'}],                       schedule: 'Сб 10:00' },
        { name: 'Вікторія Лисенко', age: 16, course: 'branding', phone: '+380506006006', status: 'active', teacher: 'Богдан Коваль',  lessonType: 'group',      scheduleDays: [{day:'2',time:'18:00'}],                       schedule: 'Вт 18:00' },
...
const ANIMATION_META_RU = {
  title: 'Курс брендинга и логотипов для подростков — My Computer Academy, обучение онлайн',
  desc:  'Курс разработки фирменного стиля для подростков 12–18 лет онлайн. Логотип, цвета, шрифты, собственный брендбук. Малые группы до 5 человек. Первый урок бесплатно.',
};
...
app.get('/sitemap.xml', (req, res) => {
  const base  = 'https://branding.mycomputer.school';
...
const ARTICLE_LABEL_MAP = {
  ...
  '🎭': {label:'Дизайн',            cls:'cat-design'},
  '🧭': {label:'Дизайн',            cls:'cat-design'},
  '🏷️': {label:'Брендинг',          cls:'cat-design'},
  '🤖': {label:'AI-дизайн',         cls:'cat-design'},
};
...
app.get('/articles', (req, res) => {
  ...
  const siteUrl = 'https://branding.mycomputer.school';
...
app.post('/api/leads', leadsLimiter, (req, res) => {
  ...
  try {
    ...
    const sanitized = {
      ...
      source:     'branding.mycomputer.school',
    };
    ...
    if (process.env.MAIN_ADMIN_TOKEN) {
      fetch('https://mycomputer.education/api/leads/admin', {
        ...
        body: JSON.stringify({ ...sanitized, course: sanitized.course || 'Брендинг (лендинг)', notes: 'Заявка з branding.mycomputer.school' }),
      }).catch(() => {});
    }
...
app.get('/articles/:slug', (req, res) => {
  ...
  <meta property="og:image" content="https://branding.mycomputer.school/og-image.png?v=2"/>
