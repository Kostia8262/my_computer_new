...
const SEED = [
  { name: 'Тетяна В.', initials: 'ТВ', role: 'мама Матвія, 15 років · Брендинг',
    text: '"Дуже сподобались матеріали курсу — усе розкладено по поличках, є відеозаписи занять, які можна передивитись перед домашнім завданням. Матвій розробив свій перший логотип і вже пишається брендбуком у портфоліо."',
    rating: 5 },
  { name: 'Олег М.', initials: 'ОМ', role: 'тато Дарини, 16 років · Брендинг',
    text: '"Донька завжди любила малювати, а тепер вміє поєднувати це з логікою — чому один колір «працює» для бренду, а інший ні. Курс дав системний погляд на дизайн, а не просто малювання."',
    rating: 5 },
  { name: 'Наталя С.', initials: 'НС', role: 'мама Микити, 13 років · Брендинг',
    text: '"Боялися, що робота в Illustrator — це занадто складно для підлітка. Даремно, все пояснюють крок за кроком, від ескізу на папері до вектора. Результат перевершив очікування!"',
    rating: 5 },
  { name: 'Ірина П.', initials: 'ІП', role: 'мама Максима, 17 років · Брендинг',
    text: '"Син розробив повний брендбук для вигаданої кав\'ярні і одразу оформив його для портфоліо. Тепер каже, що хоче вступати саме на графічний дизайн — курс визначив напрямок."',
    rating: 5 },
];
